 ...
 * @docs-private
 */
export declare function dispatchMouseEvent(node: Node, type: string, clientX?: number, clientY?: number, button?: number, buttons?: number, detail?: number, modifiers?: ModifierKeys, relatedTarget?: Element): MouseEvent;
/**
