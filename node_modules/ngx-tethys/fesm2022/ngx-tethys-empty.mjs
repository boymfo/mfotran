...
class ThyEmptyConfig {
    ...
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyConfig, deps: [], target: i0.ɵɵFactoryTarget.Injectable }); }
    static { this.ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyConfig }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyConfig, decorators: [{
            type: Injectable
        }] });
...
class ThyEmpty {
    ...
    constructor(thyTranslate, thyEmptyConfig, elementRef, ngZone, sanitizer) {
...
class ThyEmptyModule {
    static { this.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule }); }
    static { this.ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyModule, imports: [CommonModule, ThySharedModule, ThyIconModule, ThyEmpty], exports: [ThyEmpty] }); }
    static { this.ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyModule, providers: [ThyEmptyConfig], imports: [CommonModule, ThySharedModule, ThyIconModule, ThyEmpty] }); }
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyEmptyModule, decorators: [{
            type: NgModule,
            args: [{
...
export { ThyEmpty, ThyEmptyConfig, ThyEmptyModule };
//# sourceMappingURL=ngx-tethys-empty.mjs.map
