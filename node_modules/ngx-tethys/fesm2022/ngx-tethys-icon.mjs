...
import { SecurityContext, Injectable, Inject, numberAttribute, booleanAttribute, Component, ChangeDetectionStrategy, ViewEncapsulation, Input, HostBinding, NgModule } from '@angular/core';
...
class ThyIconRegistry {
    ...
    getIconFailedToSanitizeLiteralError(literal) {
        return Error(`The literal provided to ThyIconRegistry was not trusted as safe HTML by ` +
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyIconRegistry, decorators: [{
        ...
        }], ctorParameters: () => [{ type: i1.DomSanitizer }, { type: i2.HttpClient }, { type: undefined, decorators: [{
                    type: Inject,
                    args: [DOCUMENT]
                }] }] });
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "17.2.3", ngImport: i0, type: ThyIcon, decorators: [{
            ...
            args: [{
        ...
        }], ctorParameters: () => [{ type: i0.Renderer2 }, { type: i0.ElementRef }, { type: ThyIconRegistry }], propDecorators: { iconType: [{
                type: Input,
                args: ['thyIconType']
            }], iconTwotoneColor: [{
                type: Input,
                ...
                type: Input,
                args: [{ alias: 'thyIconLegging', transform: booleanAttribute }]
            }], iconLinearGradient: [{
                type: Input,
                args: [{ alias: 'thyIconLinearGradient', transform: booleanAttribute }]
            }] } });
