...
export declare class DragRef<T = any> {
    ...
    constructor(element: ElementRef<HTMLElement> | HTMLElement, drag: ThyDragDirective, container: IThyDropContainerDirective<T>, dragDropService: ThyDragDropService<T>, document: any, ngZone: NgZone, renderer: Renderer2);
