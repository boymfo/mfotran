...
export declare const THY_NOTIFY_DEFAULT_CONFIG: InjectionToken<ThyGlobalNotifyConfig>;
export declare const THY_NOTIFY_DEFAULT_CONFIG_VALUE: ThyGlobalNotifyConfig;
export declare const THY_NOTIFY_DEFAULT_CONFIG_PROVIDER: {
    provide: InjectionToken<ThyGlobalNotifyConfig>;
    useValue: ThyGlobalNotifyConfig;
};
