...
!function (DayPilot) {
    ...
    function n(e, t) {
        "string" == typeof t && (t = DayPilot.Locale.find(t)), t = t || DayPilot.Locale.US;
        ...
        this.init = function () { this.year = this.findSequence("yyyy") || this.findSequence("yy"), this.month = this.findSequence("MMMM") || this.findSequence("MMM") || this.findSequence("MM") || this.findSequence("M"), this.day = this.findSequence("dd") || this.findSequence("d"), this.hours = this.findSequence("HH") || this.findSequence("H"), this.minutes = this.findSequence("mm") || this.findSequence("m"), this.seconds = this.findSequence("ss") || this.findSequence("s"), this.ampm = this.findSequence("tt"), this.hours12 = this.findSequence("hh") || this.findSequence("h"); }, this.findSequence = function (t) {
            ...
            return e.indexOf(t) === -1 ? null : { "findValue": function (r) {
    ...
    if ("undefined" == typeof DayPilot.$) {
        "undefined" == typeof DayPilot.Global && (DayPilot.Global = {}), DayPilot.$ = function (e) { return document.getElementById(e); }, DayPilot.touch = {}, DayPilot.touch.start = "touchstart", DayPilot.touch.move = "touchmove", DayPilot.touch.end = "touchend", DayPilot.mo3 = function (e, t) {
            ...
            var i = !!n.styleSheet, a = {};
            return a.rules = [], a.commit = function () { i && (n.styleSheet.cssText = this.rules.join("\n")); }, a.add = function (e, t, a) { return i ? void this.rules.push(e + "{" + t + "}") : void (n.sheet.insertRule ? ("undefined" == typeof a && (a = n.sheet.cssRules.length), n.sheet.insertRule(e + "{" + t + "}", a)) : n.sheet.addRule && n.sheet.addRule(e, t, a)); }, a;
            ...
            var n = "object" == typeof e.data, i = e.data, a = e.method || (e.data ? "POST" : "GET"), r = e.success || function () { }, o = e.error || function () { }, s = e.url, l = e.contentType || (n ? "application/json" : "text/plain"), d = e.headers || {};
            ...
            return t;
        }, DayPilot.Util.ownPropsAsArray = function (e) { return e ? Object.entries(e).map(function (e) { return { key: e[0], val: e[1] }; }) : []; }, DayPilot.Util.atLeast = function (e, t) { return Math.max(e, t); }, DayPilot.Util.mouseButton = function (e) {
            var t = {};
            switch (e.button) {
                case 0:
                    t.left = !0;
            ...
            this.f = [], this.j = [], this.k = {}, this.selectedClass = null, this.syncScrollbar = !0, this.l = null, this.m = DayPilot.Date.today(), this.n = null, this.onChange = null, this.onChanged = null, this.onSelect = null, this.k.updateMode = function (e) { var t = n.k.control; t && (t.selectMode = e, t.select(n.m)); }, this.addView = function (e, t) {
                ...
                if ("string" == typeof e) {
                    ...
                    i = e;
                var a = i, r = {};
                return r.o = !0, r.p = a.id, r.control = a, r.q = t || {}, r.s = function () { a.hide ? a.hide() : a.nav && a.nav.top ? a.nav.top.style.display = "none" : a.style.display = "none"; }, r.t = function (e) { (function () { return !!a.backendUrl || !("function" != typeof WebForm_DoCallback || !a.uniqueID); })() ? a.commandCallBack && a.commandCallBack("navigate", { "day": e }) : (a.startDate = e, a.update()); }, r.u = function () { n.z(), a.show ? a.show() : a.nav && a.nav.top ? a.nav.top.style.display = "" : a.style.display = ""; }, r.A = function () {
                    if (r.q.navigatorSelectMode)
                        return r.q.navigatorSelectMode;
                    if (a.isCalendar)
                        switch (a.viewType) {
                            case "Day": return "day";
                ...
                a || (a = this.addView(t));
                var r = {};
                return r.C = !0, r.D = i, r.p = i.id, r.E = a, r.F = function (e) { n.show(r), n.G(r), null === e || void 0 === e ? void 0 : e.preventDefault(); }, DayPilot.re(i, "click", r.F), this.j.push(r), r;
            ...
            var t = this, n = 864e5, i = 36e5, a = 6e4, r = 1e3;
            if (2 === arguments.length) {
        ...
        DayPilot.Date = function (e, n) {
            if (e instanceof DayPilot.Date)
                return e;
            var i;
            DayPilot.Util.isNullOrUndefined(e) && (i = DayPilot.DateUtil.fromLocal().getTime(), e = i);
            var a = DayPilot.Date.Cache.Ctor;
            if (a[e])
                return DayPilot.Stats.cacheHitsCtor += 1, a[e];
            var r = !1;
            ...
            var o = t(i);
            return a[o] ? a[o] : (a[o] = this, a[i] = this, r && o !== e && DayPilot.DateUtil.hasTzSpec(e) && (a[e] = this), Object.defineProperty ? (Object.defineProperty(this, "ticks", { get: function () { return i; } }), Object.defineProperty(this, "value", { "value": o, "writable": !1, "enumerable": !0 })) : (this.ticks = i, this.value = o), DayPilot.Date.Config.legacyShowD && (this.d = new Date(i)), void (DayPilot.Stats.dateObjects += 1));
            ...
            var n = e.length, i = 10 === n, a = 19 === n, r = n > 19;
            if (!i && !a && !r)
            ...
            if (e = new DayPilot.Date(e), t = new DayPilot.Date(t), e.getTime() > t.getTime())
                return null;
            ...
            return i + ":" + n;
        }, DayPilot.DateUtil.max = function (e, t) { return e.getTime() > t.getTime() ? e : t; }, DayPilot.DateUtil.min = function (e, t) { return e.getTime() < t.getTime() ? e : t; }, DayPilot.ColorUtil = {}, DayPilot.ColorUtil.hexToRgb = function (e) {
    ...
    if ("undefined" == typeof DayPilot.Calendar || !DayPilot.Calendar.events) {
        ...
        t.selectedCells = [], t.topSelectedCell = null, t.bottomSelectedCell = null, t.column = null, t.firstSelected = null, t.firstMousePos = null, t.originalMouse = null, t.originalHeight = null, t.originalTop = null, t.resizing = null, t.globalHandlers = !1, t.moving = null, t.register = function (e) {
            ...
            for (var n = [], i = t.getColumn(e), a = e.parentNode, r = null; a && r !== t.firstSelected;)
        ...
        t.Calendar = function (e, a) {
            ...
            this.clearSelection = function () { t.topSelectedCell = null, t.bottomSelectedCell = null, this.S(); }, this.S = function () { DayPilot.de(o.elements.selection), o.elements.selection = [], o.nav.activeSelection = null; }, this.T = function (e, t, n) { var i = {}; i.action = e, i.parameters = n, i.data = t, i.header = this.U(); var a = "JSON" + JSON.stringify(i); __doPostBack(o.uniqueID, a); }, this.V = function (e, t, n) { this.callbackTimeout && window.clearTimeout(this.callbackTimeout), this.callbackTimeout = window.setTimeout(function () { o.loadingStart(); }, 100); var i = {}; i.action = e, i.parameters = n, i.data = t, i.header = this.U(); var a = "JSON" + JSON.stringify(i); this.backendUrl ? DayPilot.request(this.backendUrl, this.W, a, this.ajaxError) : "function" == typeof WebForm_DoCallback && WebForm_DoCallback(this.uniqueID, a, this.X, this.clientName, this.onCallbackError, !0); }, this.onCallbackError = function (e, t) { alert("Error!\r\nResult: " + e + "\r\nContext:" + t); }, this.dispose = function () { var e = o; e.Q || (e.Q = !0, clearInterval(e.Y), e.Z(), e.nav.scroll.root = null, DayPilot.pu(e.nav.loading), e._(), e.aa(), e.nav.select = null, e.nav.cornerRight = null, e.nav.scrollable = null, e.nav.zoom = null, e.nav.loading = null, e.nav.header = null, e.nav.hourTable = null, e.nav.scrolltop = null, e.nav.scroll.onscroll = null, e.nav.scroll = null, e.nav.main = null, e.nav.message = null, e.nav.messageClose = null, e.nav.top = null, t.unregister(e)); }, this.disposed = function () { return this.Q; }, this.ba = function () { this.nav.top.dispose = this.dispose; }, this.W = function (e) { o.X(e.responseText); }, this.U = function () { var e = {}; return e.control = "dpc", e.id = this.id, e.v = this.v, e.days = o.days, e.startDate = o.startDate, e.heightSpec = o.heightSpec, e.businessBeginsHour = o.businessBeginsHour, e.businessEndsHour = o.businessEndsHour, e.hashes = o.hashes, e.timeFormat = o.timeFormat, e.viewType = o.viewType, e.locale = o.locale, e; }, this.ca = function (e) {
                for (var t = e.parentNode; t && "TD" !== t.tagName;)
                    t = t.parentNode;
                var n = o.eventBorderRadius;
                "number" == typeof n && (n += "px");
                var i = document.createElement("div");
                i.setAttribute("unselectable", "on"), i.style.position = "absolute", i.style.width = e.offsetWidth + "px", i.style.height = e.offsetHeight + "px", i.style.left = e.offsetLeft + "px", i.style.top = e.offsetTop + "px", i.style.boxSizing = "border-box", i.style.zIndex = 101, i.className = o.L("_shadow");
                var a = document.createElement("div");
                return a.className = o.L("_shadow_inner"), n && (a.style.borderRadius = n, i.style.borderRadius = n), i.appendChild(a), t.firstChild.appendChild(i), i;
            }, this.R.locale = function () { var e = DayPilot.Locale.find(o.locale); return e ? e : DayPilot.Locale.US; }, this.R.timeFormat = function () { return "Auto" !== o.timeFormat ? o.timeFormat : this.locale().timeFormat; }, this.R.da = function () { return "Disabled" !== o.xssProtection; }, this.R.ea = function () {
                if ("Auto" === o.weekStarts) {
                    var e = s.locale();
                    return e ? e.weekStarts : 0;
                }
                return o.weekStarts || 0;
            }, this.R.fa = function () {
                var e = o.cellDuration;
                if (e <= 1)
                    return 1;
                if (e >= 60)
                    return 60;
                ...
                if ("None" === t.UpdateType)
                    return o.loadingStop(), void o.u();
                if (o.Z(), "Full" === t.UpdateType && (o.columns = t.Columns, o.days = t.Days, o.startDate = new DayPilot.Date(t.StartDate), o.heightSpec = t.HeightSpec ? t.HeightSpec : o.heightSpec, o.businessBeginsHour = t.BusinessBeginsHour ? t.BusinessBeginsHour : o.businessBeginsHour, o.businessEndsHour = t.BusinessEndsHour ? t.BusinessEndsHour : o.businessEndsHour, o.headerDateFormat = t.HeaderDateFormat ? t.HeaderDateFormat : o.headerDateFormat, o.viewType = t.ViewType, o.backColor = t.BackColor ? t.BackColor : o.backColor, o.eventHeaderVisible = t.EventHeaderVisible ? t.EventHeaderVisible : o.eventHeaderVisible, o.timeFormat = t.TimeFormat ? t.TimeFormat : o.timeFormat, o.locale = t.Locale ? t.Locale : o.locale, o.ga()), t.Hashes)
                    for (var n in t.Hashes)
                        o.hashes[n] = t.Hashes[n];
                o.events.list = t.Events, o.ha(), o.ia(), "Full" === t.UpdateType && (o.ja(), o.ka(), o.la(), o.ma()), o.u(), o.na(), o.clearSelection(), o.afterRender(t.CallBackData, !0), o.loadingStop();
            }, this.oa = function () { return this.pa() / 36e5; }, this.qa = function () { return this.businessBeginsHour > this.businessEndsHour ? 24 - this.businessBeginsHour + this.businessEndsHour : this.businessEndsHour - this.businessBeginsHour; }, this.ra = function () { return this.pa() / (60 * s.fa() * 1e3); }, this.pa = function () { var e = 0; return e = "BusinessHoursNoScroll" === this.heightSpec ? this.qa() : 24, 60 * e * 60 * 1e3; }, this.sa = function () { return "BusinessHoursNoScroll" === this.heightSpec ? this.businessBeginsHour : 0; }, this.ta = function () { return 2 === o.api; }, this.eventClickCallBack = function (e, t) { this.V("EventClick", t, e); }, this.eventClickPostBack = function (e, t) { this.T("EventClick", t, e); }, this.va = function (e) {
                var t = e.currentTarget, n = t.event;
            ...
            }, this.eventDeleteCallBack = function (e, t) { this.V("EventDelete", t, e); }, this.eventDeletePostBack = function (e, t) { this.T("EventDelete", t, e); }, this.ya = function (e) {
                if (o.ta()) {
                    var t = {};
                ...
                var a = {};
                a.e = e, a.newStart = t, a.newEnd = n, this.V("EventResize", i, a);
                ...
                if (!n)
                    throw "newEnd is null";
                var a = {};
                a.e = e, a.newStart = t, a.newEnd = n, this.T("EventResize", i, a);
            }, this.K = function (e, t, n, i) {
                var a = 0, r = new Date, s = new Date;
                if ("top" === i ? (r = o.za(e, n - a), s = e.end()) : "bottom" === i && (r = e.start(), s = o.Aa(e, n + t - a)), o.ta()) {
                    var l = {};
                ...
                if (!n)
                    throw "newEnd is null";
                var r = {};
                r.e = e, r.newStart = t, r.newEnd = n, this.T("EventMove", a, r);
                ...
                if (!n)
                    throw "newEnd is null";
                var r = {};
                r.e = e, r.newStart = t, r.newEnd = n, this.V("EventMove", a, r);
            }, this.M = function (e, t, n, i) {
                var a = 0, r = Math.floor((n - a) / o.cellHeight);
                o.snapToGrid || (r = (n - a) / o.cellHeight);
                var l = s.fa(), d = r * l * 60 * 1e3, c = e.start(), u = e.end(), h = new Date;
            ...
            }, this.timeRangeSelectedPostBack = function (e, t, n, i) { var a = {}; a.start = e, a.end = t, this.T("TimeRangeSelected", i, a); }, this.timeRangeSelectedCallBack = function (e, t, n, i) { var a = {}; a.start = e, a.end = t, this.V("TimeRangeSelected", i, a); }, this.O = function (e, t, n) {
                ...
                !function () {
                    var t = e.start.column, n = e.start.columnIndex, i = t.start, a = o.getPixels(e.startTime, i), r = o.getPixels(e.endTime, i), s = a.boxTop, l = r.boxBottom;
                    o.snapToGrid || (s = a.top, l = r.top);
                    var d = l - s, c = o.eventBorderRadius;
                    ...
                    var u = function () {
                        ...
                        return t.setAttribute("unselectable", "on"), t.className = o.L("_shadow_inner"), c && (t.style.borderRadius = c, e.style.borderRadius = c), e.appendChild(t), o.nav.events.rows[0].cells[n].selection.appendChild(e), o.elements.selection.push(e), o.nav.activeSelection = e, e;
                    }();
            ...
            }, this.Fa = function () { var e = DayPilot.Global.selecting; e.end = o.coords, e.end.time = o.Da(e.start.x, e.end.y), e.end.column = o.Ba[o.Ea(e.end.x)], o.Ha(e); }, this.Ha = function (e) { var t, n, i; o.snapToGrid ? e.end.time < e.start.time ? (t = o.Ia(e.end.time, e.start.column.start), n = o.Ja(e.start.time, e.start.column.start), i = e.endTime) : (t = o.Ia(e.start.time, e.start.column.start), n = o.Ja(e.end.time, e.start.column.start), i = e.startTime) : e.end.time < e.start.time ? (t = e.end.time, n = e.start.time, i = e.endTime) : (t = e.start.time, n = e.end.time, i = e.startTime), e.startTime = t, e.endTime = n, e.anchor = i; }, this.getSelection = function () {
                if (!o.N)
                    return null;
                var e = o.N;
                ...
                for (var t = 0, n = o.nav.events.rows[0].cells, i = 0; i < n.length; i++) {
                ...
                if (e.x = 0, e.y = 0, !o.coords)
                    return null;
                e.x = o.Ea(o.coords.x);
                var t = 0, n = Math.floor((o.coords.y - t) / o.cellHeight);
                ...
                o.columnsLoadMethod && "POST" === o.columnsLoadMethod.toUpperCase() ? DayPilot.ajax({ "method": "POST", "url": e, "success": a, "error": i }) : DayPilot.ajax({ "method": "GET", "url": e, "success": a, "error": i });
            }, this.ga = function () {
                var e;
                ...
                var n = this.Ba.length - 1;
                return this.Ba[n].start.addDays(1);
            }, this.L = function (e) { var t = this.theme || this.cssClassPrefix; return t ? t + e : ""; }, this.Z = function () {
                ...
                s.style.position = "absolute", s.style.left = e.part.left + "%", s.style.top = e.part.top + "px", s.style.width = e.part.width + "%", s.style.height = Math.max(e.part.height, 2) + "px", s.style.overflow = "hidden", s.data = e, s.event = e, s.unselectable = "on", s.style.MozUserSelect = "none", s.style.KhtmlUserSelect = "none", s.className = this.L("_event"), i.cssClass && DayPilot.Util.addClass(s, i.cssClass), o.showToolTip && e.client.toolTip() && (s.title = e.client.toolTip()), s.isFirst = e.part.start.getTime() === e.start().getTime(), s.isLast = e.part.end.getTime() === e.end().getTime(), s.onclick = this.va, DayPilot.re(s, "contextmenu", this.xa), s.onmouseout = function () { s.deleteIcon && (s.deleteIcon.style.display = "none"); }, s.onmousemove = function (n) {
                    ...
                    if ("n-resize" !== this.style.cursor && "s-resize" !== this.style.cursor || 1 !== i) {
                        ...
                        t.resizing = this, DayPilot.Global.resizing = this, t.originalMouse = DayPilot.mc(n), t.originalHeight = this.offsetHeight, t.originalTop = this.offsetTop, o.nav.top.style.cursor = this.style.cursor;
                    return !1;
                };
                ...
                if (DayPilot.Areas.attach(s, e, { "areas": p }), "function" == typeof o.onAfterEventRender) {
                    var m = {};
                ...
                for (var t = o.oa(), n = 0; n < t; n++)
                    this.cb(e, n);
                return e;
            }, this.cb = function (e, t) { var n = 60 * o.cellHeight / s.fa(), i = e.insertRow(-1); i.style.height = n + "px"; var a = i.insertCell(-1); a.valign = "bottom", a.unselectable = "on", a.style.cursor = "default", a.style.padding = "0px", a.style.border = "0px none"; var r = document.createElement("div"); r.style.position = "relative", r.className = this.L("_rowheader"), r.style.width = this.hourWidth + "px", r.style.height = n + "px", r.style.overflow = "hidden", r.unselectable = "on"; var l = document.createElement("div"); l.className = this.L("_rowheader_inner"), l.unselectable = "on"; var d = document.createElement("div"); d.unselectable = "on"; var c = this.startDate.addHours(t).addHours(o.sa()), u = c.getHours(), h = u < 12, f = s.timeFormat(); "Clock12Hours" === f && (u %= 12, 0 === u && (u = 12)), d.innerHTML = u; var v = document.createElement("span"); v.unselectable = "on", v.className = this.L("_rowheader_minutes"); var p; p = "Clock12Hours" === f ? h ? "AM" : "PM" : "00", v.innerHTML = p, d.appendChild(v), l.appendChild(d), r.appendChild(l), a.appendChild(r); }, this.Xa = function () {
                var e = s.fa(), t = 60 / e;
                ...
                if (i.appendChild(this.nav.header), r) {
                ...
                e && (!function () {
                    var t = e, i = t.domArgs;
                    if (t.domArgs = null, i && "function" == typeof o.onBeforeCellDomRemove && o.onBeforeCellDomRemove(i), i && "function" == typeof o.onBeforeCellDomAdd) {
                        var a = i && i.Pa;
                        if (a) {
                ...
                var e = s.fa(), i = this.nav.main, a = 60 * e * 1e3, r = this.ra(), l = o.Ba;
                for (i && this._(); i && i.rows && i.rows.length > 0;)
                    this.fasterDispose || DayPilot.pu(i.rows[0]), i.deleteRow(0);
                this.tableCreated = !0;
                for (var d = this.nav.events; d && d.rows && d.rows.length > 0;)
                    this.fasterDispose || DayPilot.pu(d.rows[0]), d.deleteRow(0);
                for (var c = l.length, u = d.insertRow(-1), h = 0; h < c; h++) {
                ...
                for (var m = 0; m < r; m++) {
                    ...
                    for (var y = function (e) {
                        var t = b.Ba[e], i = g.insertCell(-1);
                        i.start = t.start.addTime(m * a), i.end = i.start.addTime(a), i.resource = t.id, i.onmousedown = b.Ca, i.onmouseup = function () { return !1; }, i.onclick = function () { return !1; }, i.root = b, i.style.padding = "0px", i.style.border = "0px none", i.style.verticalAlign = "top", i.style.height = o.cellHeight + "px", i.style.overflow = "hidden", i.unselectable = "on";
                        var r = document.createElement("div");
                        r.unselectable = "on", r.style.height = o.cellHeight + "px", r.style.position = "relative", r.className = b.L("_cell");
                        var s = b.gb(i.start, i.end), l = { "business": s, "text": null, "html": null, "cssClass": null, "backColor": null, "backImage": null, "backRepeat": null, "fontColor": null }, d = { "start": i.start, "end": i.end, "resource": i.resource, "properties": l, "x": e, "y": m };
                        !function () {
                            if ("function" == typeof o.onBeforeCellRender) {
                                var e = {};
                                e.cell = d, o.onBeforeCellRender(e);
                            }
                        }(), l.business && DayPilot.Util.addClass(r, o.L("_cell_business")), l.cssClass && DayPilot.Util.addClass(r, l.cssClass);
                        var c = document.createElement("div");
                        c.setAttribute("unselectable", "on"), c.className = b.L("_cell_inner");
                        var u = DayPilot.Util.escapeTextHtml(l.text, l.html);
                        u && (c.innerHTML = u), l.backColor && (c.style.backgroundColor = l.backColor), l.backImage && (c.style.backgroundImage = "url(" + l.backImage + ")"), l.backRepeat && (c.style.backgroundRepeat = l.backRepeat), l.fontColor && (c.style.color = l.fontColor), r.appendChild(c), function () {
                            if ("function" == typeof o.onBeforeCellDomAdd || "function" == typeof o.onBeforeCellDomRemove) {
                                var e = {};
                ...
                i.root = this, o.nav.scrollable.onmousemove = function (e) {
                    var n = o.nav.scrollable;
                    o.coords = DayPilot.mo3(n, e);
                    var i = DayPilot.mc(e);
                    if (t.resizing) {
                ...
                function t(t) {
                    var a = i[t], r = e ? n.insertCell(-1) : n.cells[t];
                    r.data = a, r.style.overflow = "hidden", r.style.padding = "0px", r.style.border = "0px none", r.style.height = o.headerHeight + "px", r.onclick = o.ib;
                    ...
                    l.firstChild.innerHTML = o.$a(a.name, a.html);
                }
                for (var n = e ? this.nav.header.insertRow(-1) : this.nav.header.rows[0], i = this.Ba, a = i.length, r = 0; r < a; r++)
                    t(r);
            }, this.ib = function (e) {
                ...
                return null;
            }, this.events.forRange = function (e, t) { return e = new DayPilot.Date(e), t = new DayPilot.Date(t), (o.events.list || []).filter(function (n) { return i(e, t, new DayPilot.Date(n.start), new DayPilot.Date(n.end)); }).map(function (e) { return new DayPilot.Event(e, o); }); }, this.events.update = function (e) {
                if (e instanceof DayPilot.Event)
                    e.commit();
                ...
                var i = DayPilot.indexOf(o.events.list, t);
                o.events.list.splice(i, 1), o.qb({ "eventsOnly": !0 }), o.wa.notify();
                ...
                var t = this.xb.events, n = this.events.list[e], i = {};
                for (var a in n)
                    i[a] = n[a];
            ...
            }, this.debug = function (e) { this.debuggingEnabled && (o.debugMessages || (o.debugMessages = []), o.debugMessages.push(e), "undefined" != typeof console && console.log(e)); }, this.getPixels = function (e, t) {
                t || (t = this.startDate);
                var n = t.getTime(), i = e.getTime(), a = s.fa(), r = this.cache.pixels[i + "_" + n];
                if (r)
                    return r;
                n = t.getTime();
                var o = 60 * a * 1e3, l = i - n, d = l % o, c = l - d, u = c + o;
                0 === d && (u = c);
                var h = {};
                return h.cut = !1, h.top = this.Ab(l), h.boxTop = this.Ab(c), h.boxBottom = this.Ab(u), this.cache.pixels[i + "_" + n] = h, h;
            ...
            e && e.directive("daypilotCalendar", ["$parse", function (e) {
                    return { "restrict": "E", "template": "<div></div>", "replace": !0, "link": function (t, n, i) {
                            ...
                            for (var s in i)
                                0 === s.indexOf("on") && !function (n) { a[n] = function (a) { var r = e(i[n]); t["$apply"](function () { r(t, { "args": a }); }); }; }(s);
    ...
    if ("undefined" == typeof DayPilot.Menu || !DayPilot.Menu.def) {
        ...
        t.mouse = null, t.menu = null, t.handlersRegistered = !1, t.hideTimeout = null, t.waitingSubmenu = null, DayPilot.Menu = function (n) {
            ...
            if (this.Qb = function () { }, n && DayPilot.isArray(n) && (this.items = n), this.toJSON = function () { return null; }, this.show = function (n, r) {
                ...
                if (n ? "string" == typeof n.id || "number" == typeof n.id ? o = n.id : "function" == typeof n.id ? o = n.id() : "function" == typeof n.value && (o = n.value()) : o = null, "undefined" != typeof DayPilot.Bubble && DayPilot.Bubble.hideActive(), r.submenu || t.menuClean(), this.Qb.submenu = null, null !== t.mouse) {
                                    ...
                                    if (h.onclick)
                                        ...
                                        var y = function (e, t) {
                                            return function (n) {
                                                ...
                                                if (n.preventDefault(), i instanceof DayPilot.Link)
                    ...
                    if (function () {
                        ...
                        var e = "number" == typeof r.x ? r.x : t.mouse.x + 1, n = "number" == typeof r.y ? r.y : t.mouse.y + 1, a = document.body.scrollTop || document.documentElement.scrollTop, o = document.body.scrollLeft || document.documentElement.scrollLeft, s = 0, l = 0;
                        if (n - a > H - A && 0 !== H) {
                            s = n - (n - a - (H - A) + N);
                        }
                        else
                            s = n;
                        if (i.Qb.y = s, d.style.top = s + "px", "right" === r.align && (e -= E), e - o > R - E && 0 !== R) {
                            l = e - (e - o - (R - E) + N);
                        }
                        else
                            l = e;
                        i.Qb.x = l, d.style.left = l + "px";
                    }(), r.parentLink) {
                ...
                var n = e, a = t.source;
                if ((!i.Qb.submenu || i.Qb.submenu.item !== e) && (i.Qb.submenu && i.Qb.submenu.item !== e && (DayPilot.Util.removeClass(i.Qb.submenu.link.parentNode, i.Rb("item_haschildren_active")), i.Qb.submenu.menu.hide(), i.Qb.submenu = null), e.items)) {
            ...
            this.Ub = function (e) { return this.theme + "_" + e; }, this.u = function () {
                ...
                t.className = this.Ub("main"), DayPilot.list(n.items).forEach(function (e) {
                    ...
                    i.innerHTML = DayPilot.Util.escapeTextHtml(e.text, e.html), i.className = n.Ub("item"), e.cssClass && i.classList.add(e.cssClass), i.data = e, i.onclick = function (t) {
                    ...
                    }, i.onmousedown = function (e) { e.stopPropagation(); }, i.onmouseover = function () { n.active && n.active.item !== e && n.Wb(i); }, t.appendChild(i), n.elements.items.push(i);
                });
        ...
        }, t.mousePosition = function (e) { return DayPilot.mo3(null, e); }, DayPilot.Menu.touchPosition = function (e) { e.touches && (t.mouse = t.touchPosition(e)); }, DayPilot.Menu.mousePosition = function (e) { t.mouse = t.mousePosition(e); }, DayPilot.Menu.hide = function (e) {
            if (e = e || {}, e.calendar) {
    ...
    if (!DayPilot.ModalStatic) {
        ...
        d.add(".modal_default_main", "border: 10px solid #ccc; max-width: 90%;"), d.add(".modal_default_main:focus", "outline: none;"), d.add(".modal_default_content", "padding: 10px 0px;"), d.add(".modal_default_inner", "padding: 20px;"), d.add(".modal_default_input", "padding: 10px 0px;"), d.add(".modal_default_buttons", "margin-top: 10px;"), d.add(".modal_default_buttons", "padding: 10px 0px;"), d.add(".modal_default_form_item", "padding: 10px 0px; position: relative;"), d.add(".modal_default_form_item_level1", "border-left: 2px solid #ccc; margin-left: 10px; padding-left: 20px;"), d.add(".modal_default_form_item.modal_default_form_title", "font-size: 1.5rem; font-weight: bold;"), d.add(".modal_default_form_item input[type=text]", "width: 100%; box-sizing: border-box;"), d.add(".modal_default_form_item textarea", "width: 100%; height: 200px; box-sizing: border-box;"), d.add(".modal_default_form_item input[type=select]", "width: 100%; box-sizing: border-box;"), d.add(".modal_default_form_item label", "display: block;"), d.add(".modal_default_form_item select", "width: 100%; box-sizing: border-box;"), d.add(".modal_default_form_item_label", "margin: 2px 0px;"), d.add(".modal_default_form_item_image img", "max-width: 100%; height: auto;"), d.add(".modal_default_form_item_invalid", ""), d.add(".modal_default_form_item_invalid_message", "position: absolute; right: 0px; top: 9px; background-color: red; color: #ffffff; padding: 2px; border-radius: 2px;"), d.add(".modal_default_background", "opacity: 0.5; background-color: #000;"), d.add(".modal_default_ok", "padding: 3px; width: 80px;"), d.add(".modal_default_cancel", "padding: 3px; width: 80px;"), d.add(".modal_default_form_item_date", "position: relative;"), d.add(".modal_default_form_item_date:after", "content: ''; position: absolute; right: 7px; top: 50%; margin-top: 3px; width: 10px; height: 15px; background-image:url(" + "data:image/svg+xml;base64," + ")"), "undefined" != typeof navigator && navigator.userAgent.indexOf("Edge") !== -1 && d.add(".modal_default_form_item_date input::-ms-clear", "display: none;"), d.add(".modal_default_form_item_scrollable_scroll", "width: 100%; height: 200px; box-sizing: border-box; border: 1px solid #ccc; overflow-y: auto;"), d.add(".modal_default_form_item_scrollable_scroll_content", "padding: 5px;"), d.add(".modal_default_form_item_searchable", "position: relative;"), d.add(".modal_default_form_item_searchable_icon", ""), d.add(".modal_default_form_item_searchable_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + l + ");"), d.add(".modal_default_form_item_searchable_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"), d.add(".modal_default_form_item_searchable_list_item", "background: white; padding: 2px; cursor: default;"), d.add(".modal_default_form_item_searchable_list_item_highlight", "background: #ccc;"), d.add(".modal_default_form_item_time", "position: relative;"), d.add(".modal_default_form_item_time_icon", ""), d.add(".modal_default_form_item_time_icon:after", "content:''; position: absolute; right: 5px; top: 50%; margin-top: -8px; width: 10px; height: 15px; background-image:url(" + l + ");"), d.add(".modal_default_form_item_time_list", "box-sizing: border-box; border: 1px solid #999; max-height: 150px; overflow-y: auto;"), d.add(".modal_default_form_item_time_list_item", "background: white; padding: 2px; cursor: default;"), d.add(".modal_default_form_item_time_list_item_highlight", "background: #ccc;"), d.add(".modal_default_form_item_datetime_parent", "display: flex;"), d.add(".modal_default_form_item_datetime .modal_default_form_item_time_main", "margin-left: 5px;"), d.add(".modal_default_form_item_datetime input[type='text'].modal_default_input_date ", ""), d.add(".modal_default_form_item_tabular_main", "margin-top: 10px;"), d.add(".modal_default_form_item_tabular_table", "display: table; width: 100%; xbackground-color: #fff; border-collapse: collapse;"), d.add(".modal_default_form_item_tabular_tbody", "display: table-row-group;"), d.add(".modal_default_form_item_tabular_row", "display: table-row;"), d.add(".modal_default_form_item_tabular_row.modal_default_form_item_tabular_header", ""), d.add(".modal_default_form_item_tabular_cell.modal_default_form_item_tabular_rowaction", "padding: 0px; width: 23px;"), d.add(".modal_default_form_item_tabular_cell", "display: table-cell; border: 0px; padding: 2px 2px 2px 0px; cursor: default; vertical-align: bottom;"), d.add(".modal_default_form_item_tabular_header .modal_default_form_item_tabular_cell", "padding-left: 0px; padding-bottom: 0px;"), d.add(".modal_default_form_item_tabular_table input[type=text], .modal_default_form_item_tabular_table input[type=number]", "width:100%; box-sizing: border-box;"), d.add(".modal_default_form_item_tabular_table select", "width:100%; height:100%; box-sizing: border-box;"), d.add(".modal_default_form_item_tabular_plus", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), d.add(".modal_default_form_item_tabular_plus:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"), d.add(".modal_default_form_item_tabular_delete", "display: inline-block; background-color: #ccc; color: white; width: 20px; height: 20px; border-radius: 10px; box-sizing: border-box; position: relative; margin-left: 3px; margin-top: 3px; cursor: pointer;"), d.add(".modal_default_form_item_tabular_delete:after", "content: ''; position: absolute; left: 5px; top: 5px; width: 10px; height: 10px;   background-image: url(\"data:image/svg+xml;base64,\")"), d.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_plus", "display: none;"), d.add(".modal_default_form_item_tabular_plus_max.modal_default_form_item_tabular_plus", "display: none;"), d.add(".modal_default_form_item_tabular_disabled .modal_default_form_item_tabular_delete", "visibility: hidden;"), d.add(".modal_default_form_item_tabular_empty", "height: 1px; margin: 5px 23px 5px 0px; background-color: #ccc;"), d.add(".modal_default_form_item_tabular_spacer .modal_default_form_item_tabular_cell", "padding: 0px;"), d.add(".modal_min_main", "border: 1px solid #ccc; max-width: 90%;"), d.add(".modal_min_background", "opacity: 0.5; background-color: #000;"), d.add(".modal_min_ok", "padding: 3px 10px;"), d.add(".modal_min_cancel", "padding: 3px 10px;"), d.add(".navigator_modal_main", "border-left: 1px solid #c0c0c0;border-right: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;background-color: white;color: #000000; box-sizing: content-box;"), d.add(".navigator_modal_main *, .navigator_modal_main *:before, .navigator_modal_main *:after", "box-sizing: content-box;"), d.add(".navigator_modal_month", "font-size: 11px;"), d.add(".navigator_modal_day", "color: black;"), d.add(".navigator_modal_weekend", "background-color: #f0f0f0;"), d.add(".navigator_modal_dayheader", "color: black;"), d.add(".navigator_modal_line", "border-bottom: 1px solid #c0c0c0;"), d.add(".navigator_modal_dayother", "color: gray;"), d.add(".navigator_modal_todaybox", "border: 1px solid red;"), d.add(".navigator_modal_title, .navigator_modal_titleleft, .navigator_modal_titleright", "border-top: 1px solid #c0c0c0;border-bottom: 1px solid #c0c0c0;color: #333;background: #f3f3f3;"), d.add(".navigator_modal_busy", "font-weight: bold;"), d.add(".navigator_modal_cell", "text-align: center;"), d.add(".navigator_modal_select .navigator_modal_cell_box", "background-color: #FFE794; opacity: 0.5;"), d.add(".navigator_modal_title", "text-align: center;"), d.add(".navigator_modal_titleleft, .navigator_modal_titleright", "text-align: center;"), d.add(".navigator_modal_dayheader", "text-align: center;"), d.add(".navigator_modal_weeknumber", "text-align: center;"), d.add(".navigator_modal_cell_text", "cursor: pointer;"), d.add(".navigator_modal_todaysection", "box-sizing: border-box; display: flex; align-items: center; justify-content: center; border-top: 1px solid var(--dp-nav-border-color);"), d.add(".navigator_modal_todaysection_button", "cursor: pointer; color: #333; background-color: #f0f0f0; border: 1px solid var(--dp-nav-border-color); padding: 5px 10px; border-radius: 0px; "), d.commit(), DayPilot.Modal = function (e) {
            ...
            this.id = "_" + (new Date).getTime() + "n" + 10 * Math.random(), this.Yb = !1, this.Zb = null, this.$b = null, this.showHtml = function (e) {
                ...
                if (t) {
                    ...
                    t.open(n, o, !0), t.setRequestHeader("Content-type", "text/plain"), t.onreadystatechange = function () {
                        if (4 === t.readyState)
            ...
            return DayPilot.getPromise(function (t) {
                ...
                c.value = r, c.style.width = "100%", c.onkeydown = function (e) {
                    var t = !1;
                    switch (e.keyCode) {
                        case 13:
                            o.close(this.value);
                ...
                h.innerText = i, h.className = o.theme + "_ok", h.onclick = function () { o.close(c.value); };
                var f = document.createTextNode(" "), v = document.createElement("button");
                v.innerText = a, v.className = o.theme + "_cancel", v.onclick = function () { o.close(); }, u.appendChild(h), u.appendChild(f), u.appendChild(v), s.appendChild(l), s.appendChild(d), s.appendChild(u), o.showHtml(s), o.autoFocus && c.focus();
            });
        };
        ...
        DayPilot.Modal.form = function (n, i, a) {
            ...
            for (var d in a)
                l[d] = a[d];
            l.height = l.height || 40, l.useIframe = !1;
            var u = l.okText || "OK", h = l.cancelText || "Cancel";
            return DayPilot.getPromise(function (a) {
                l.onClosed = function (t) {
                    if (t.result) {
                ...
                var s = document.createElement("div");
                s.className = r.theme + "_input";
                var d = new t({ theme: r.theme, form: n, data: i, zIndex: r.zIndex, locale: r.locale, plugins: r.plugins, onKey: function (e) {
                        switch (e.key) {
                            case "Enter":
                    ...
                    }, onChange: function (e) { "function" == typeof r.onChange && r.onChange(e); } }), c = d.create();
                s.append(c);
                var f = document.createElement("div");
                f.className = r.theme + "_buttons";
                var v = document.createElement("button");
                v.innerText = u, v.className = r.theme + "_ok", l.okDisabled && (v.disabled = !0), v.onclick = function () { d.validate() && r.close(d.serialize()); };
                var p = document.createTextNode(" "), m = document.createElement("button");
                if (m.innerText = h, m.className = r.theme + "_cancel", m.onclick = function () { r.close(); }, m.onmousedown = function () { d.canceling = !0; }, f.appendChild(v), f.appendChild(p), f.appendChild(m), o.appendChild(s), o.appendChild(f), r.showHtml(o), r.div.setAttribute("tabindex", "-1"), r.div.addEventListener("keydown", function (e) {
                    switch (e.keyCode) {
                        case 27:
                            r.close();
                            break;
        ...
        }, DayPilot.Modal.close = function (e) { var t = DayPilot.Modal.opener(); t && t.close(e); }, DayPilot.Modal.stretch = function () {
            ...
            }, r.onBlur = function () { n.canceling || n.Cc(r); }, r.apply(e), r.Bc = i, r.row = e, r.element && i.appendChild(r.element), this.f.push(r), this.Bc.appendChild(i);
        }, t.prototype.validate = function () { var e = this, t = !0; return this.f.forEach(function (n) { var i = e.Cc(n); t = t && i; }), t; }, t.prototype.Cc = function (e, t) {
            ...
            t = t || {};
            var i = t.debounce, a = t.silent, r = e.row, o = !0, s = "function" == typeof r.data.onValidate ? r.data.onValidate : null, l = "function" == typeof r.data.validate ? r.data.validate : null, d = s || l;
            if (d) {
                var c = {};
            ...
            for (var i in t)
                this.setValue(i, t[i]);
        }, t.prototype.setValue = function (e, t) { this.yc.forEach(function (n) { n.applyValue(e, t); }); }, t.prototype.updateDependentState = function () { var e = this, t = [!0]; (this.zc ? this.zc : this.yc).forEach(function (n) { var i = e.updateState(n, { enabled: t[n.level] && !n.data.disabled }); i.isValue && (t[i.level + 1] = i.enabled && i.checked); }); }, t.prototype.processFormItem = function (e, t) {
            ...
            var t = this, n = { "label": function () { return new i; }, "title": function () { return new i; }, "image": function () { var t = new i, n = document.createElement("img"); return n.src = e.data.image, t.element = n, t; }, "html": function () { var t = new i, n = document.createElement("div"); return "string" == typeof e.data.text ? n.innerText = e.data.text : "string" == typeof e.data.html && (n.innerHTML = e.data.html), t.element = n, t; }, "scrollable": function () { var n = new i, a = document.createElement("div"); a.className = t.theme + "_form_item_scrollable_scroll", e.data.height && (a.style.height = e.data.height + "px"); var r = document.createElement("div"); return r.className = t.theme + "_form_item_scrollable_scroll_content", "string" == typeof e.data.text ? r.innerText = e.data.text : "string" == typeof e.data.html && (r.innerHTML = e.data.html), a.appendChild(r), n.element = a, n; }, "text": function () {
                    ...
                    }, a.oninput = function () { n.onInput(); }, a.onblur = function () { n.onBlur(); }, n.element = a, n.canFocus = function () { return !n.element.disabled; }, n.focus = function () { n.element.focus(), n.element.setSelectionRange(0, n.element.value.length); }, n.save = function () { var t = {}; return t[e.field] = a.value, t; }, n;
                }, "textarea": function () {
                    var n = new i;
                    n.apply = function (e) { n.row = e; var t = n.element; t.value = e.value, t.disabled = !e.enabled; };
                    ...
                    return a.name = e.field, e.data.height && (a.style.height = e.data.height + "px"), a.onkeydown = function (e) {
                        ...
                        n || e.stopPropagation();
                    }, a.oninput = function () { n.onInput(); }, a.onblur = function () { n.onBlur(); }, n.element = a, n.canFocus = function () { return !n.element.disabled; }, n.focus = function () { n.element.focus(), n.element.setSelectionRange(0, 0); }, n.save = function () { var t = {}; return t[e.field] = a.value, t; }, n;
                }, "date": function () {
                    var n = new i;
                    n.apply = function (e) { n.row = e; var i = n.element, a = n.picker; e.data.dateFormat && (a.pattern = e.data.dateFormat); var r = e.data.locale || t.locale; r && (a.locale = r), i.disabled = !e.enabled, a.date = new DayPilot.Date(e.value); var o = new DayPilot.Date(e.value).toString(e.data.dateFormat || a.pattern, a.locale); i.value = o; };
                    var a = document.createElement("input");
                    a.name = e.field;
                    var r = new DayPilot.DatePicker({ target: a, theme: "navigator_modal", zIndex: t.zIndex + 1, resetTarget: !1, targetAlignment: "left", onTimeRangeSelect: function () { n.onInput({ "immediate": !0 }); } });
                    return a.picker = r, a.className = t.theme + "_input_date", a.type = "text", a.onkeydown = function (e) {
                        var n = !1;
                        switch (e.keyCode) {
                            case 13:
            ...
            var a = [], o = e.data.timeInterval || 15;
            [1, 5, 10, 15, 20, 30, 60].includes(o) || (o = 15);
            for (var s = 60 / o, l = e.data.locale || t.locale, d = DayPilot.Locale.find(l) || DayPilot.Locale.US, c = DayPilot.Date.today(), u = 0; u < 24 * s; u++) {
                var h = c.addMinutes(o * u), f = {};
                f.name = h.toString(e.data.timeFormat || d.timePattern, d), f.id = h.toString("HH:mm"), a.push(f);
            }
            var v = new r({ data: a, name: e.field, theme: t.theme + "_form_item_time", listZIndex: t.zIndex + 1, strategy: "startsWith", onSelect: function (e) { e.ui && n.onInput({ "immediate": !0 }); } }), p = v.create();
            ...
            var a = function () {
                ...
                i.name = e.field;
                var a = new DayPilot.DatePicker({ target: i, theme: "navigator_modal", zIndex: t.zIndex + 1, resetTarget: !1, targetAlignment: "left", onTimeRangeSelect: function () { n.onInput({ "immediate": !0 }); } });
                return i.picker = a, i.className = t.theme + "_input_date", i.type = "text", i.onkeydown = function (e) {
                    ...
                    n || (e.preventDefault(), e.stopPropagation());
                }, i.onfocus = function () { a.show(); }, i.onclick = function () { a.show(); }, i.oninput = function () { n.onInput(); }, i.onblur = function () { n.onBlur(); }, n.dateInput = i, n.picker = a, i;
            }(), o = function () {
                var i = [], a = e.data.timeInterval || 15;
                [1, 5, 10, 15, 20, 30, 60].includes(a) || (a = 15);
                for (var o = 60 / a, s = e.data.locale || t.locale, l = DayPilot.Locale.find(s) || DayPilot.Locale.US, d = DayPilot.Date.today(), c = 0; c < 24 * o; c++) {
                    var u = d.addMinutes(a * c), h = {};
                    h.name = u.toString(e.data.timeFormat || l.timePattern, l), h.id = u.toString("HH:mm"), i.push(h);
                }
                var f = new r({ data: i, name: e.field, theme: t.theme + "_form_item_time", listZIndex: t.zIndex + 1, strategy: "startsWith", onSelect: function (e) { e.ui && n.onInput({ "immediate": !0 }); } });
                return n.searchable = f, f.create();
            }(), s = document.createElement("div");
            return s.className = t.theme + "_form_item_datetime_parent", s.appendChild(a), s.appendChild(o), n.element = s, n.canFocus = function () { return !n.searchable.disabled; }, n.focus = function () { n.dateInput.focus(); }, n.save = function () { var t = n.searchable.selected && n.searchable.selected.id, i = n.picker.date ? n.picker.date.toString() : null, a = new DayPilot.Date(i).getDatePart(), r = DayPilot.Date.parse(a.toString("yyyy-dd-MM ") + t, "yyyy-dd-MM HH:mm"), o = {}; return o[e.field] = r, o; }, n;
            ...
            var n = this.zc ? this.zc : this.yc, i = n.indexOf(e);
            ...
            function e(e) {
                ...
                l.data.forEach(function (n) {
                    ...
                    if ("includes" === e) {
                        ...
                        return;
                    var o = document.createElement("div");
                    o.className = l.theme + "_list_item", o.innerText = r, o.item = n, n === l.Ic && (l.Jc = o), a || (a = o), o.addEventListener("mousedown", function (e) { i(o), e.preventDefault(); }), o.addEventListener("mousemove", function () { l.Jc !== o && (l.Jc = o, t({ dontScroll: !0 })); }), h.appendChild(o), l.q.push(o);
                }), l.Jc || (l.Jc = a), t();
            }
            ...
            function i(e) { var t = e.item; l.Ic = t, l.Pc(!0), r(), o(); }
            function a() { l.Oc(); }
            function r() { l.s(); }
            ...
            var u = document.createElement("div");
            u.className = this.theme + "_icon", u.style.position = "absolute", u.style.right = "0", u.style.top = "0", u.style.bottom = "0", u.style.width = "20px", u.addEventListener("mousedown", function (e) { e.preventDefault(), l.Kc ? (l.focus(), s()) : (a(), o()); });
            ...
            return v.type = "text", v.className = this.theme + "_input", v.disabled = this.Hc, v.addEventListener("click", function () { s(); }), v.addEventListener("focus", function () { e("all"); }), v.addEventListener("input", function () { e(); }), v.addEventListener("blur", function () { v.removeAttribute("readonly"), a(); }), v.addEventListener("keydown", function (e) {
                if (l.Kc) {
                    if ("Enter" === e.key)
                        return;
                ...
                if ("ArrowDown" === e.key) {
                    ...
                    "Enter" === e.key ? l.Jc ? (e.stopPropagation(), i(l.Jc)) : (e.stopPropagation(), a(), o()) : "Esc" !== e.key && "Escape" !== e.key || (e.stopPropagation(), a(), o());
            ...
            return c.className = this.theme + "_plus", c.addEventListener("click", function () {
                if (!e.disabled) {
            ...
            return a.className = this.theme + "_delete", a.addEventListener("click", function () { t.disabled || (t.Zc(e), t.Uc(), t.Vc()); }), e.spacer || i.appendChild(a), n.appendChild(i), n;
    ...
    if ("undefined" == typeof DayPilot.Month || !DayPilot.Month.events) {
        ...
        e.Month = function (n, i) {
            ...
            this.X = function (e) { var t = JSON.parse(e); return t.CallBackRedirect ? void (document.location.href = t.CallBackRedirect) : "None" === t.UpdateType ? void a.fireAfterRenderDetached(t.CallBackData, !0) : (a.events.list = t.Events, "Full" === t.UpdateType && (a.startDate = t.StartDate, a.timeFormat = t.TimeFormat ? t.TimeFormat : a.timeFormat, "undefined" != typeof t.WeekStarts && (a.weekStarts = t.WeekStarts), a.hashes = t.Hashes), a.Z(), a.bd(), a.ha(), "Full" === t.UpdateType && (a.cd(), a.dd()), a.ma(), a.show(), a.na(), void a.fireAfterRenderDetached(t.CallBackData, !0)); }, this.fireAfterRenderDetached = function (e, t) { var n = function (e, t) { return function () { a.afterRender && a.afterRender(e, t); }; }; window.setTimeout(n(e, t), 0); }, this.lineHeight = function () { return this.eventHeight + this.lineSpace; }, this.events = {}, this.events.add = function (e) {
                ...
                var i = function (e) { var t = {}; t.exception = e.exception, t.request = e.request, "function" == typeof n && n(t); }, r = function (e) {
                    var n, r = e.request;
                    try {
            ...
            }, this.events.forRange = function (e, t) { e = new DayPilot.Date(e), t = new DayPilot.Date(t); var n = (a.events.list || []).map(function (e) { return new DayPilot.Event(e); }); return n.sort(a.zb), n.filter(function (n) { var i = n.start(), a = n.end(); return i === a && i === e || DayPilot.Util.overlaps(e, t, i, a); }); }, this.update = function (e) {
                if (a.sb(e), this.La) {
                    if (a.Q)
                ...
                var n = e.start().getTime() - t.start().getTime();
                return 0 !== n ? n : t.end().getTime() - e.end().getTime();
            }, this.drawShadow = function (t, n, i, r, o) {
                o || (o = 0);
                var s = r;
                this.shadow = {}, this.shadow.list = [], this.shadow.start = { x: t, y: n }, this.shadow.width = r;
                var l = 7 * n + t - o;
                l < 0 && (s += l, t = 0, n = 0);
                for (var d = o; d >= 7;)
                    n--, d -= 7;
                ...
                n < 0 && (n = 0, t = 0);
                var c = null;
                e.resizingEvent ? c = "w-resize" : e.movingEvent && (c = "move"), this.nav.top.style.cursor = c;
                var u = a.eventBorderRadius;
                for ("number" == typeof u && (u += "px"); s > 0 && n < this.rows.length;) {
                ...
                for (var i = function (e) {
                    ...
                    t.start = r.firstDate.addDays(7 * e), t.end = t.start.addDays(r.getColCount()), t.events = [], t.lines = [], t.index = e, t.minHeight = r.cellHeight, t.calendar = r, t.belongsHere = function (e) { return e.end().getTime() === e.start().getTime() && e.start().getTime() === this.start.getTime() || !(e.end().getTime() <= this.start.getTime() || e.start().getTime() >= this.end.getTime()); }, t.getPartStart = function (e) { return DayPilot.DateUtil.max(this.start, e.start()); }, t.getPartEnd = function (e) { return DayPilot.DateUtil.min(this.end, e.end()); }, t.getStartColumn = function (e) { var t = this.getPartStart(e); return DayPilot.DateUtil.daysDiff(this.start, t); }, t.getWidth = function (e) { return DayPilot.DateUtil.daysSpan(this.getPartStart(e), this.getPartEnd(e)) + 1; }, t.putIntoLine = function (e, n, i, a) {
                        ...
                        var l = [];
                        return l.isFree = function (e, t) {
                            for (var n = !0, i = 0; i < this.length; i++)
                                e + t - 1 < this[i].part.colStart || e > this[i].part.colStart + this[i].part.colWidth - 1 || (n = !1);
                            return n;
                        }, l.addEvent = function (e, t, n, i, a) { e.part.colStart = t, e.part.colWidth = n, e.part.row = i, e.part.line = a, e.part.startsHere = r.start.getTime() <= e.start().getTime(), e.part.endsHere = r.end.getTime() >= e.end().getTime(), this.push(e); }, l.addEvent(e, n, i, a, this.lines.length), this.lines.push(l), this.lines.length - 1;
                    }, t.getHeight = function () { return Math.max(this.lines.length * a.lineHeight() + a.cellHeaderHeight + a.cellMarginBottom, this.calendar.cellHeight); }, r.rows.push(t);
                }, r = this, o = 0; o < n; o++)
                    i(o);
                this.endDate = this.firstDate.addDays(7 * n);
                ...
                for (var n = Math.floor(this.nav.top.clientWidth / this.getColCount()), i = Math.min(Math.floor(e / n), this.getColCount() - 1), a = null, r = this.headerHeight, o = 0, s = 0; s < this.rows.length; s++) {
                    var l = r;
                ...
                var d = {};
                return d.x = i, d.y = a, d.relativeY = o, d;
            ...
            }, this.ta = function () { return 2 === a.api; }, this.gd = function (n, i, o) {
                ...
                var g = document.createElement("div");
                g.setAttribute("unselectable", "on"), p.appendChild(g), g.style.position = "absolute", g.style.left = "0px", g.style.right = "0px", g.style.top = "0px", g.style.bottom = "0px", g.className = this.L("_cell_inner"), v.backColor && (g.style.backgroundColor = f.cell.properties.backColor), p.onmousedown = function () { "Disabled" !== a.timeRangeSelectedHandling && (a.clearShadow(), e.timeRangeSelecting = { "root": a, "x": n, "y": i, "from": { x: n, y: i }, "width": 1 }); }, p.onclick = function () {
                ...
                }(), this.cells[n][i] = p, o.appendChild(p);
            ...
            }, this.fd = function (e) { var t = e.currentTarget; return a.xa(t.event), !1; }, this.xa = function (e) {
            ...
            }, this.eventDeleteCallBack = function (e, t) { this.V("EventDelete", t, e); }, this.eventDeletePostBack = function (e, t) { this.T("EventDelete", t, e); }, this.eventMoveCallBack = function (e, t, n, i, a) {
                if (!t)
                    throw "newStart is null";
                if (!n)
                    throw "newEnd is null";
                var r = {};
                r.e = e, r.newStart = t, r.newEnd = n, r.position = a, this.V("EventMove", i, r);
            }, this.M = function (e, t, n, i, r) {
                var o = e.start().getTimePart(), s = e.end().getDatePart();
                s.getTime() !== e.end().getTime() && (s = s.addDays(1));
                var l = DayPilot.DateUtil.diff(e.end(), s), d = this.getDateFromCell(t, n);
                d = d.addDays(-i);
                var c = DayPilot.DateUtil.daysSpan(e.start(), e.end()) + 1, u = d.addDays(c), h = d.addTime(o), f = u.addTime(l);
                if (a.ta()) {
                    var v = {};
                ...
                var i = e.start().getTimePart(), r = e.end().getDatePart();
                r.getTime() !== e.end().getTime() && (r = r.addDays(1));
                var o = DayPilot.DateUtil.diff(e.end(), r), s = this.getDateFromCell(t.x, t.y), l = s.addDays(n), d = s.addTime(i), c = l.addTime(o);
                if (a.ta()) {
                    var u = {};
            ...
            }, this.timeRangeSelectedCallBack = function (e, t, n) { var i = {}; i.start = e, i.end = t, this.V("TimeRangeSelected", n, i); }, this.O = function (e, t) {
                if (this.ta()) {
                    var n = {};
            ...
            }, this.Eb = function () { this.bd(), this.Wa(), this.dd(), this.pb(), this.V("Init"); }, this.$a = function (e, t) { return a.R.da() ? DayPilot.Util.escapeTextHtml(e, t) : DayPilot.Util.isNullOrUndefined(t) ? DayPilot.Util.isNullOrUndefined(e) ? "" : e : t; }, this.Ra = {}, this.Ra.Qa = null, this.Ra.Lb = function (e, t, n) {
                var i = a.Ra.Qa;
                if ("function" == typeof i.createVNode && "function" == typeof i.render) {
        ...
        DayPilot.Navigator = function (i, a) {
            function r(e, t, n) {
                ...
                this.is = function (e) { return this.month === e.month && this.x === e.x && this.y === e.y; }, this.next = function () {
                    ...
                    return e.y < t.rowCount - 1 ? { "month": e.month, "x": 0, "y": e.y + 1 } : e.month < o.months.length - 1 ? { "month": e.month + 1, "x": 0, "y": 0 } : null;
                    ...
                    return e;
                }, this.cell = function () { return o.months[this.month].cells[this.x][this.y]; }, this.date = function () { return this.cell().day; }, this.before = function (e) { return this.date() < new r(e).date(); };
            }
            this.v = "${v}";
            var o = this;
            ...
            this.nav = {}, this.xb = {}, this.jd = function () { this.root.dp = this, this.root.className = this.L("_main"), "Horizontal" === this.orientation ? (s.kd() || (this.root.style.width = this.showMonths * (7 * s.cellWidth() + this.ld()) + "px"), this.root.style.height = 6 * this.cellHeight + this.titleHeight + this.dayHeaderHeight + "px") : s.kd() || (this.root.style.width = 7 * s.cellWidth() + this.ld() + "px"), this.rtl && (this.root.style.direction = "rtl"), this.root.style.position = "relative", this.visible || (this.root.style.display = "none"); var e = document.createElement("input"); e.type = "hidden", e.name = o.id + "_state", e.id = e.name, this.root.appendChild(e), this.state = e, this.startDate ? this.startDate = new DayPilot.Date(this.startDate).firstDayOfMonth() : this.selectionDay ? this.startDate = new DayPilot.Date(this.selectionDay).firstDayOfMonth() : this.startDate = DayPilot.Date.fromYearMonthDay(this.year, this.month), this.calendars = [], this.selected = [], this.months = []; }, this.ta = function () { return 2 === o.api; }, this.cd = function () { this.root.innerHTML = ""; }, this.L = function (e) { var t = this.theme || this.cssClassPrefix; return t ? t + e : ""; }, this.md = function (e, t) { var n = this.L("_" + t); DayPilot.Util.addClass(e, n); }, this.nd = function (e, t) { var n = this.L("_" + t); DayPilot.Util.removeClass(e, n); }, this.od = function () {
            ...
            }, this.pd = function () { return s.kd() ? null : s.cellWidth(); }, this.qd = function (e) { return "number" != typeof e && (e = 1), s.kd() ? this.od() * e : this.pd() * e; }, this.rd = function (e) { var t = s.kd() ? "%" : "px"; return this.qd(e) + t; }, this.dd = function (i, a) {
                var r = {};
                r.cells = [], r.days = [], r.weeks = [];
                var l = this.startDate.addMonths(i), d = a.before, c = a.after, u = l.firstDayOfMonth(), h = u.firstDayOfWeek(s.weekStarts()), f = u.addMonths(1), v = DayPilot.DateUtil.daysDiff(h, f), p = "Auto" === this.rowsPerMonth ? Math.ceil(v / 7) : 6;
                r.rowCount = p;
                var m = (new DayPilot.Date).getDatePart(), g = 7 * s.cellWidth() + this.ld();
                r.width = g;
                var y = this.cellHeight * p + this.titleHeight + this.dayHeaderHeight;
                r.height = y;
                var b = document.createElement("div");
                if (s.kd() ? "Horizontal" === this.orientation && (b.style.width = 100 / o.showMonths + "%") : b.style.width = g + "px", b.style.height = y + "px", "Horizontal" === this.orientation)
                ...
                b.className = this.L("_month"), b.style.cursor = "default", b.style.userSelect = "none", b.style.webkitUserSelect = "none", b.month = r, r.div = b, this.root.appendChild(b);
                var x = this.titleHeight + this.dayHeaderHeight, _ = document.createElement("div");
                _.style.position = "absolute", _.style.left = "0px", _.style.right = "0px", _.style.top = "0px", _.style.width = o.rd(), _.style.height = this.titleHeight + "px", _.style.lineHeight = this.titleHeight + "px", _.className = this.L("_titleleft"), a.left && (_.style.cursor = "pointer", _.innerHTML = "<span>&lt;</span>", _.onclick = this.sd), b.appendChild(_);
                var C = document.createElement("div");
                C.style.position = "absolute", C.style.left = o.rd(), C.style.top = "0px", C.style.width = o.rd(o.showWeekNumbers ? 6 : 5), C.style.height = this.titleHeight + "px", C.style.lineHeight = this.titleHeight + "px", C.className = this.L("_title"), C.innerHTML = s.locale().monthNames[l.getMonth()] + " " + l.getYear(), b.appendChild(C), this.ti = C;
                var k = document.createElement("div");
                k.style.position = "absolute", k.style.left = o.rd(o.showWeekNumbers ? 7 : 6), k.style.right = o.rd(o.showWeekNumbers ? 7 : 6), k.style.top = "0px", k.style.width = o.rd(), k.style.height = this.titleHeight + "px", k.style.lineHeight = this.titleHeight + "px", k.className = this.L("_titleright"), a.right && (k.style.cursor = "pointer", k.innerHTML = "<span>&gt;</span>", k.onclick = this.td), b.appendChild(k), this.tr = k;
                var D = o.showWeekNumbers ? 1 : 0;
                ...
                for (var E = 0; E < 7; E++) {
                    ...
                    for (var H = function (i) {
                        var a = h.addDays(7 * i + E), u = R.vd(a) && "none" !== R.wd(), f = a.firstDayOfMonth() === l, v = a < l, p = a >= l.addMonths(1);
                        if ("month" === R.wd())
                            u = u && f;
                        else if ("day" === R.wd())
                            u = u && (f || d && v || c && p);
                        ...
                        var y = document.createElement("div");
                        r.cells[E][i] = y;
                        var w = o.xd(E, i), x = w.x, _ = w.y, C = s.kd() ? "%" : "px";
                        y.day = a, y.x = E, y.y = i, y.left = x, y.top = _, y.isCurrentMonth = f, y.isNextMonth = p, y.isPrevMonth = v, y.showBefore = d, y.showAfter = c, y.className = R.L(f ? "_day" : "_dayother"), o.md(y, "cell"), a.getTime() === m.getTime() && f && R.md(y, "today"), 0 !== a.dayOfWeek() && 6 !== a.dayOfWeek() || R.md(y, "weekend"), y.style.position = "absolute", y.style.left = x + C, y.style.right = x + C, y.style.top = _ + "px", y.style.width = o.rd(), y.style.height = R.cellHeight + "px", y.style.lineHeight = R.cellHeight + "px";
                        var k = document.createElement("div");
                        k.style.position = "absolute", k.className = a.getTime() === m.getTime() && f ? R.L("_todaybox") : R.L("_daybox"), o.md(k, "cell_box"), k.style.left = "0px", k.style.top = "0px", k.style.right = "0px", k.style.bottom = "0px", y.appendChild(k);
                        var D = null;
                        R.cells && R.cells[a.toStringSortable()] && (D = R.cells[a.toStringSortable()]);
                        var S = D || {};
                        if (S.day = a, S.isCurrentMonth = f, S.isToday = a.getTime() === m.getTime() && f, S.isWeekend = 0 === a.dayOfWeek() || 6 === a.dayOfWeek(), D ? (S.html = D.html || a.getDay(), S.cssClass = D.css) : (S.html = a.getDay(), S.cssClass = null), S.events = { all: function () { var e; return (null === (e = o.items) || void 0 === e ? void 0 : e[a.toStringSortable()]) || []; } }, "function" == typeof o.onBeforeCellRender) {
                            var M = {};
                        ...
                        }(), b.appendChild(y), u && (o.Ad(b, E, i), R.selected.push(y));
                    }, R = this, S = 0; S < p; S++)
                        H(S);
                }
                var N = document.createElement("div");
                N.style.position = "absolute", N.style.left = "0px", N.style.top = x - 2 + "px", N.style.width = o.rd(7 + D), N.style.height = "1px", N.style.fontSize = "1px", N.style.lineHeight = "1px", N.className = this.L("_line"), b.appendChild(N), this.months.push(r);
            ...
            }, this.Ad = function (e, t, n) { var i = e.month.cells[t][n]; o.md(i, "select"); }, this.Bd = function (e, t, n) { var i = e.month.cells[t][n]; o.nd(i, "select"); }, this.ld = function () { return this.showWeekNumbers ? s.cellWidth() : 0; }, this.Cd = function () {
                var e;
                if (this.items)
            ...
            }, this.Dd = function () { var e = {}; e.startDate = o.startDate, e.selectionStart = o.selectionStart, e.selectionEnd = o.selectionEnd.addDays(1), o.state.value = JSON.stringify(e); }, this.wd = function () { return (this.selectMode || "").toLowerCase(); }, this.Ed = function () {
            ...
            }, this.update = function (e) { o.Kd(e); }, this.Kd = function (e) {
                if (o.sb(e), this.La) {
                    if (o.Q)
            ...
            }, this.qb = function () { this.cd(), this.jd(), this.ha(), this.Ed(), this.Id(), this.Cd(), this.Dd(), this.visible ? this.show() : this.hide(); }, this.Ld = function () { o.xb = {}; }, this.ub = null, this.sb = function (e) {
                if (e) {
            ...
            }, this.V = function (e, t, n) { var i = {}; i.action = e, i.parameters = n, i.data = t, i.header = this.U(); var a = "JSON" + JSON.stringify(i); this.backendUrl ? DayPilot.request(this.backendUrl, this.W, a, this.Md) : WebForm_DoCallback(this.uniqueID, a, this.X, null, this.callbackError, !0); }, this.Md = function (e) {
                if ("function" == typeof o.onAjaxError) {
                    var t = {};
                    t.request = e, o.onAjaxError(t);
                }
                else
                    "function" == typeof o.ajaxError && o.ajaxError(e);
            }, this.W = function (e) { o.X(e.responseText); }, this.T = function (e, t, n) { var i = {}; i.action = e, i.parameters = n, i.data = t, i.header = this.U(); var a = "JSON" + JSON.stringify(i); __doPostBack(o.uniqueID, a); }, this.U = function () { var e = {}; return e.v = this.v, e.startDate = this.startDate, e.selectionStart = this.selectionStart, e.showMonths = this.showMonths, e; }, this.ud = function (e) { var t = e + s.weekStarts(); return t > 6 && (t -= 7), s.locale().dayNamesShort[t]; }, this.vd = function (e) { return null !== this.selectionStart && null !== this.selectionEnd && (this.selectionStart.getTime() <= e.getTime() && e.getTime() <= this.selectionEnd.getTime()); }, this.Nd = function (e) {
                ...
                if (!s.kd())
                    return void (o.Pd = o.cellWidth);
                var e = o.months[0].cells[0][0], t = e.clientWidth;
                o.Pd = t, o.months.forEach(function (e) { e.width = e.div.clientWidth, "Horizontal" === o.orientation && (e.left = e.div.offsetLeft), e.cells.forEach(function (e, n) { e.forEach(function (e) { e.width = t, e.left = n * t; }); }); });
            }, this.Qd = function (e) {
                o.Od();
                var t = DayPilot.mo3(o.nav.top, e), n = o.Nd(t);
                if (null === n)
                    return null;
                var i = o.months[n], a = this.titleHeight + this.dayHeaderHeight;
            ...
            }, l.start = null, l.drawCell = function (e) {
                var t = o.months[e.month], n = o.xd(e.x, e.y), i = t.top + n.y, a = t.left + n.x, r = "px", d = o.rd();
                if (s.kd()) {
                    var c = "Horizontal" === o.orientation ? o.showMonths : 1;
                    a = t.leftPct + n.x / c, r = "%", d = o.rd(1 / c);
                }
                var u = document.createElement("div");
                u.style.position = "absolute", u.style.left = a + r, u.style.top = i + "px", u.style.height = o.cellHeight + "px", u.style.width = d, u.style.backgroundColor = "#ccc", u.style.opacity = .5, u.style.cursor = "default", o.nav.preselection.appendChild(u), l.cells.push(u);
            }, l.clear = function () {
                if (l.cells) {
                ...
                var e = l.ordered(), t = new r(e.start), n = e.end;
                if (n) {
            ...
            }, l.ordered = function () { var e = l.start, t = l.end, n = {}; return !t || new r(e).before(t) ? (n.start = e, n.end = t) : (n.start = t, n.end = e), n; }, this.yd = function (e) {
                var t = e.currentTarget, n = t.parentNode, i = t.parentNode.month, a = t.x, r = t.y, s = i.cells[a][r].day;
                ...
                var t = o.selectionStart, n = o.selectionEnd.addDays(1), i = DayPilot.DateUtil.daysDiff(t, n), a = o.selectionDay;
                if (e = e || {}, o.ta()) {
                    var r = {};
            ...
            }, this.visibleRangeChangedCallBack = function (e) { var t = {}; this.V("Visible", e, t); }, this.visibleRangeChangedPostBack = function (e) { var t = {}; this.T("Visible", e, t); }, this.X = function (e) { var t = JSON.parse(e); o.items = t.Items, o.cells = t.Cells, o.cells ? o.update() : o.Cd(); }, this.Id = function () {
            ...
            }, this.wa = {}, this.wa.scope = null, this.wa.notify = function () { o.wa.scope && o.wa.scope["$apply"](); }, this.zd = {}, this.zd.reactDOM = null, this.zd.react = null, this.zd.Uc = function (e, t) {
                var n = o.zd.reactDOM;
            ...
            }, this.Ra.Ta = function (e) { var t = o.Ra.Qa; "function" == typeof t.render && t.render(null, e); }, this.internal = {}, this.internal.loadOptions = o.sb, this.internal.initialized = function () { return o.La; }, this.internal.enableVue = function (e) { o.Ra.Qa = e; }, this.internal.vueRef = function () { return o.Ra.Qa; }, this.internal.vueRendering = function () { return o.Ra.Sa; }, this.internal.upd = function (e) { o.Kd(e); }, s.locale = function () { return DayPilot.Locale.find(o.locale); }, s.weekStarts = function () {
                if ("Auto" === o.weekStarts) {
                    var e = s.locale();
                    return e ? e.weekStarts : 0;
                }
                return o.weekStarts;
            }, s.cellWidth = function () {
                if (o.xb.cellWidth)
                    return o.xb.cellWidth;
                var e = o.Zd("_cell_dimensions").width;
                return e || (e = o.cellWidth), o.xb.cellWidth = e, e;
            }, s.kd = function () { return "Auto" === o.R.cellWidth(); }, this.clearSelection = function () {
                for (var e = 0; e < this.selected.length; e++) {
                    var t = this.selected[e];
                    o.Bd(t.parentNode, t.x, t.y);
                }
                this.selected = [];
            }, this.$d = function () { return !!this.backendUrl && ("undefined" == typeof o.items || !o.items); }, this.events = {}, this.ha = function () {
            ...
            }, this.Zd = function (e) { var t = document.createElement("div"); t.style.position = "absolute", t.style.top = "-2000px", t.style.left = "-2000px", t.className = this.L(e); var n = o.root || document.body; n.appendChild(t); var i = t.offsetHeight, a = t.offsetWidth; n.removeChild(t); var r = {}; return r.height = i, r.width = a, r; }, this._d = function (e) {
                for (var t = new DayPilot.Date(e.start), n = new DayPilot.Date(e.end), i = {}, a = t.getDatePart(), r = function () { return "Date" === o.eventEndSpec ? a.getTime() <= n.getTime() : a.getTime() < n.getTime(); }; r();)
                    i[a.toStringSortable()] = 1, a = a.addDays(1);
                return i;
            }, this.show = function () { o.visible = !0, o.root.style.display = ""; }, this.hide = function () { o.visible = !1, o.root.style.display = "none"; }, this.wb = function () {
                if (this.id && this.id.tagName)
                    this.nav.top = this.id;
                else {
                    if ("string" != typeof this.id)
            ...
            }, this.ae = function () { o.nav.top.onmousedown = this.Rd, o.nav.top.onmousemove = this.Sd; }, this.pb = function () { DayPilot.re(document, "mouseup", o.be); }, this.be = function (e) {
                if (l.start && l.end) {
            ...
            }, this.dispose = function () { var e = o; e.root && (e.root.removeAttribute("style"), e.root.removeAttribute("class"), e.root.dp = null, e.root.innerHTML = null, e.root = null, e.Q = !0); }, this.disposed = function () { return this.Q; }, this.ba = function () { this.root.dispose = this.dispose; }, this.Init = this.init, this.sb(a);
            ...
            e && e.directive("daypilotNavigator", ["$parse", function (e) {
                    return { "restrict": "E", "template": "<div id='{{id}}'></div>", "compile": function (t, n) {
                            return t.replaceWith(this["template"].replace("{{id}}", n["id"])), function (t, n, i) {
                                ...
                                d.call(t, c, function (e) {
                                    for (var t in e)
                                        a[t] = e[t];
                                    a.update();
                                }, !0), d.call(t, u, function (e) { a.events.list = e, a.ha(), a.Cd(); }, !0);
                            };
                        } };
                }]);
    ...
    if ("undefined" == typeof DayPilot.Scheduler) {
        ...
        DayPilot.Scheduler = function (i, o) {
            ...
            this.ge = {};
            var c = this.ge, u = {};
            this.scrollTo = function (e) { s.he(e); }, this.he = function (e) {
                if (e) {
                    if (!s.La)
                        return void (s.ie = e);
                    var t;
            ...
            var h = s.ve;
            h.we = function (e, t, n, i) {
                var a = e, r = e + n, o = t, l = t + i;
                return s.elements.events.filter(function (e) {
                    var t = e.event, n = t.part.left, i = t.part.left + t.part.width, d = s.rowlist[t.part.dayIndex], c = d.top + t.part.top, u = c + s.eventHeight;
                    if (DayPilot.Util.overlaps(n, i, a, r) && DayPilot.Util.overlaps(c, u, o, l))
                        return !0;
                });
            }, h.xe = function () {
                var e = [], t = s.ne();
                if (!t)
                    return e;
                for (var n = t.pixels.left, i = 0; i < s.elements.events.length; i++) {
            ...
            }, this.elements.sections = [], this.elements.hsections = [], this.pe = function (e, t, n) {
                var i;
                if (e.section) {
                    var a = e.section;
                ...
                var o = r();
                o.className = s.L("_timeheader_float"), o.style.position = "absolute", o.style.left = t + "px", o.style.right = n + "px", o.style.top = "0px", o.style.bottom = "0px", o.style.overflow = "hidden";
                var l = r();
                l.className = s.L("_timeheader_float_inner"), e.Ce = l;
                var d = e.cell.th, c = !0, u = null === (i = e.domArgs) || void 0 === i ? void 0 : i.element;
                if (u) {
                    var h = l;
                ...
                for (var e = [], t = 0; t < this.elements.hsections.length; t++) {
            ...
            }, this.ze = function (e, t, n) {
                var i = e.section;
                if (i)
                    return i.De && i.De.marginLeft === t && i.De.marginRight === n ? void (i.De.stamp = s.ye) : (e.section.style.left = t + "px", e.section.style.right = n + "px", void (i.De = { marginLeft: t, marginRight: n, stamp: s.ye }));
                i = r(), i.className = s.L("_event_float"), i.style.position = "absolute", i.style.left = t + "px", i.style.right = n + "px", i.style.top = "0px", i.style.bottom = "0px", i.style.overflow = "hidden";
                var a = r();
                a.className = s.L("_event_float_inner"), a.innerHTML = e.event.client.html(), i.appendChild(a), i.De = { marginLeft: t, marginRight: n, stamp: s.ye }, e.section = i, e.insertBefore(i, e.firstChild.nextSibling), e.firstChild.innerHTML = "";
                var o = e.event, l = o.cache || o.data;
                l.fontColor && (a.style.color = l.fontColor), this.elements.sections.push(e);
            }, this.Ae = function () {
                ...
                for (var t = s.startDate.addDays(s.days), n = 0; n < e.length; n++) {
            ...
            }, this.getPixels = function (e) { var t = e.ticks - this.startDate.ticks, n = s.Ab(t), i = s.cellWidth, a = Math.floor(n / i), r = a * i; r = r < 0 ? 0 : r; var o = r + i; n % i === 0 && (o = r); var l = s.Fe(); return o = o > l ? l : o, { left: n, boxLeft: r, boxRight: o, i: a }; }, this.getDate = function (e, t, n) {
                var i = this.Ne(e, n);
                if (!i)
                    return null;
                var a = i.x, r = s.Oe(a);
                ...
                return t ? o.addTime(this.Pe(i.offset)) : o;
            }, this.Ne = function (e, t) {
                t && (e -= 1);
                var n = Math.floor(e / s.cellWidth), i = s.Oe(n);
                if (!i)
                    return null;
                var a = {};
                return a.x = n, a.offset = e % s.cellWidth, a.cell = i, a;
            }, this.Qe = function (e) {
                var t = e.ticks - this.startDate.ticks, n = 60 * s.Re() * 1e3;
                if (t < 0)
                    return { past: !0 };
                var i = Math.floor(t / n);
                return { i: i, current: s.Oe(i) };
            }, this.Ab = function (e) { var t = 60 * s.Re() * 1e3, n = s.cellWidth; return Math.floor(n * e / t); }, this.Pe = function (e) { var t = 60 * s.Re() * 1e3, n = s.cellWidth; return Math.floor(e / n * t); }, this.Se = function (e) { DayPilot.Global.touch.start || t.Te || (s.Ue = {}, s.va(this, e)); }, this.va = function (e, t) { e.event && s.Ve(e, t); }, this.xa = function (e) {
            ...
            }, this.Oe = function (e) { var t = s.Re(), n = 60 * t * 1e3; return { start: s.startDate.addTime(e * n), end: s.startDate.addTime((e + 1) * n), left: e * s.cellWidth, width: s.cellWidth }; }, this.Ve = function (e, t) {
                if ("boolean" == typeof t)
                ...
                var t = {};
                if (t.e = e, t.preventDefault = function () { this.preventDefault.value = !0; }, t.control = s, t.toJSON = function () { return DayPilot.Util.copyProps(t, {}, ["e"]); }, "function" != typeof s.onEventDelete || (s.onEventDelete(t), !t.preventDefault.value)) {
            ...
            }, this.qb = function (e) { e = e || {}, clearTimeout(s.Ze), s.timeHeader = null, s.cellProperties = {}, s.Je(), s.$e(), s.events._e(), s.R.Ld(), s.clearSelection(), s.ha(), s.af(), s.bf(), s.rb(), s.cf(), s.df(), s.ef(), s.ia(), s.Z(), s.ff(), s.gf = {}, s.hf(), s.ma(), s.if(), e.immediateEvents ? s.na() : setTimeout(function () { s.na(); }, 100), this.visible ? s.ee !== s.visible && this.show() : this.hide(), this.ee = this.visible, this.se(), s.jf(), this.kf(); }, this.kf = function () {
            ...
            }, this.Ye = function (e) { var t = e.e, n = e.newStart, i = e.newEnd, a = e.newResource; t.start(n), t.end(i), t.resource(a), s.events.update(t), s.events.zf(); }, this.Af = function (e) {
                if (e)
                    if (e.args)
                ...
                if ("object" == typeof e)
                    return s.events.findAll(function (t) {
                        for (var n in e)
                            if (e[n] !== t.data[n])
                                return !1;
                        return !0;
                ...
                return null;
            }, this.events.focus = function (e) { var t = s.Qf(e); null === t || void 0 === t ? void 0 : t.focus(); }, this.events.scrollIntoView = function (e) {
                if (s.Qf(e)) {
                ...
                for (var e = [], t = 0; t < s.events.list.length; t++) {
                    var n = new DayPilot.Event(s.events.list[t], s);
                    e.push(n);
                }
                return e;
            }, this.events.forRange = function (e, t) {
                e = e ? new DayPilot.Date(e) : s.visibleStart(), t = t ? new DayPilot.Date(t) : s.visibleEnd();
                for (var n = [], i = 0; i < s.events.list.length; i++) {
                    var a = new DayPilot.Event(s.events.list[i], s);
                ...
                var t = [], n = s.Xf(), i = DayPilot.indexOf(s.events.list, e);
                s.yb(i);
                var a = s.rowlist, r = !1;
            ...
            }, this.Uf = function (e, t) { return DayPilot.Util.isSameEvent(e, t); }, this.events.update = function (e) {
                ...
                var a = l.ig(i), r = 0, o = s.coords.x;
                a && (r = e.start().getTime() - this.hg(e.start()).getTime());
                var d = 0;
                if (t.jg)
                    if (a) {
                        ...
                        d = t.jg.getTime() - e.start().getTime();
                var f = this.getDate(o, !0).addTime(-d);
                t.kg && (f = e.start());
                var v = s.snapToGrid;
                v && (f = this.hg(f)), f = f.addTime(r);
                var p = f.addTime(i), m = f, g = p, y = this.getPixels(m), b = this.getPixels(g), w = v ? y.boxLeft : y.left, x = v && a ? b.boxRight - w : b.left - w, _ = {};
            ...
            }, this.lg = function (e) { return e.end.ticks - e.start.ticks; }, this.mg = function () { var e = t.ng.width, n = t.ng.left, i = t.og, a = t.kg.dpBorder, r = null, o = null, l = s.snapToGrid, d = !l; "left" === a ? (r = s.getDate(n, d), o = i.rawend()) : "right" === a && (r = i.start(), o = s.getDate(n + e, d, !0)), t.ng.start = r, t.ng.end = o; }, this.pg = function () {
                var e = s.coords, n = t.kg.dpBorder, i = t.kg.event, a = i.part.left;
                "right" === n && (a += i.part.width);
                var r, o, l = t.kg.event.calendar.cellWidth, d = i.part.width, c = i.part.left, u = 0, h = e.x - a, f = s.snapToGrid;
                if ("right" === n) {
                    if (r = c, f) {
            ...
            }, this.tg = function () { return this.rowHeaderWidth; }, this.ug = function () { return this.vg(s.progressiveRowRenderingPreload); }, this.vg = function (e) {
                e = e || 0;
                ...
                if (i.style.width = t + "px", i.style.height = s.ce + "px", s.divHeader = i, s.progressiveRowRendering)
                    n();
                else
                    for (var a = this.rowlist.length, r = 0; r < a; r++)
                        s.xg(r);
                s.yg(), this.divResScroll.appendChild(i);
            }, this.zg = function () {
                if (s.progressiveRowRendering)
                    for (var e = this.ug(), t = 0; t < s.rowlist.length; t++)
                        e.start <= t && t < e.end ? s.xg(t) : s.Ag(t);
            }, this.yg = function () {
                if (!s.R.Bg()) {
            ...
            }, this.Ag = function (e) { var t = s.divHeader.rows[e]; t && (DayPilot.de(t), s.divHeader.rows[e] = null); }, this.nf = function (e) { this.Ag(e), this.xg(e); }, this.xg = function (e) {
            ...
            }, this.Dg = function (e) { var t = this.row, n = s.Eg(t, this.index); s.Gf(n, e); }, this.Fg = function () {
            ...
            }, this.Eg = function (e) { return new DayPilot.Row(e, s); }, this.Tf = function (e) { var t = s.rowlist, n = t[e]; n.events || n.resetEvents(); }, this.Hg = {}, this.ha = function (e) {
                ...
                s.rowlist.forEach(function (e) { s.Jg(e); }), s.fg();
            ...
            }, this.Ig = function (e) { var t = typeof e + "_" + e; return c.rowcache[t] || []; }, this.Xf = function () {
            ...
            }, this.eg = function (e) { e = DayPilot.ua(e), e = s.of(e), e.forEach(function (e) { s.Jg(e); }), e.forEach(function (e) { s.Kg(e); }); }, this.Yf = function (e, t) {
                var n = new DayPilot.Date(e.start), i = new DayPilot.Date(e.end);
                i = s.vf(i);
                var a = n.ticks, r = i.ticks, o = s.startDate.ticks, d = s.startDate.addDays(s.days).ticks;
                if (r < a)
                    return null;
                var c = null;
                ...
                if (t.id !== e.resource || (r <= o || a >= d) && (a !== r || a !== o))
                    return null;
                var h = new DayPilot.Event(e, s);
                h.part.dayIndex = s.rowlist.indexOf(t), h.part.start = o < a ? n : s.startDate, h.part.end = d > r ? i : s.startDate.addDays(s.days);
                ...
                var a = t || 0, r = s.rowlist.find(function (t, n) { return !(n < a) && e(s.Eg(t)); });
                if (r)
                    return s.Eg(r);
                ...
                s.rowsLoadMethod && "POST" === s.rowsLoadMethod.toUpperCase() ? DayPilot.ajax({ "method": "POST", "url": e, "success": a, "error": i }) : DayPilot.ajax({ "method": "GET", "url": e, "success": a, "error": i });
                ...
                var n = e.$.row.resource, i = DayPilot.indexOf(s.resources, n);
                s.resources.splice(i, 1), s.update();
                ...
                var n = e.index, i = s.rowlist, a = i[n], r = e.data, o = s.Lg(r), l = s.Mg(o);
                l.level = a.level, l.index = n, l.top = a.top, l.height = a.height, i[n] = l, l.resetEvents(), s.Tf(l.index), s.Ng(l), s.Jg(l), s.nf(l.index), s.ff(), s.if();
            }, this.Ng = function (e) {
                for (var t = s.events.list, n = t.length, i = "function" == typeof s.onBeforeEventRender, a = 0; a < n; a++) {
                    var r = t[a];
                    if (r) {
                        if (r instanceof DayPilot.Event)
                            throw new DayPilot.Exception("DayPilot.Scheduler: DayPilot.Event object detected in events.list array. Use raw event data instead.");
                ...
                e = e || [], s.rowlist = [], this.Og(e);
            }, this.sa = function () { return new DayPilot.Date(this.startDate); }, this.Rf = function () { return new DayPilot.Date(s.startDate).addDays(s.days); }, this.visibleStart = function () { return this.sa(); }, this.visibleEnd = function () { return this.Rf(); }, this.Mg = function (e) {
                var t = {};
                return t.backColor = e.backColor, t.fontColor = e.fontColor, t.cssClass = e.cssClass, t.name = e.name, t.html = s.$a(e.name, e.html), t.id = e.id, t.toolTip = e.toolTip, t.areas = e.areas, t.tags = e.tags, t.height = s.eventHeight, t.level = 0, t.resource = e.De, t.lines = [], t.isRow = !0, t.getHeight = function () { return Math.max(s.eventHeight, this.lines.length * s.eventHeight); }, t.resetEvents = function () {
                    var e = t;
                ...
                var n = s.R.Bg();
                n && (e.style.overflowY = "auto"), e.ontouchstart = function () { t.$g = !0; }, e.oncontextmenu = function () { return !1; }, e.onscroll = function () {
                    if (s.Zg && clearTimeout(s.Zg), n) {
                        ...
                        s.Zg = setTimeout(function () { s.nav.scroll.scrollTop = e.scrollTop; }, 500);
                }, e.setAttribute("role", "region"), e.setAttribute("aria-label", "scheduler rows");
                var i = r();
                return this.divHeader = i, e.appendChild(i), this.divResScroll = e, this.Ie = e, e;
            }, this.ah = null, this.bh = null, this.ch = function () {
                var e = function () { s.dh(), s.jf(); }, t = function () {
                    var t = s.nav.top;
                    if (t) {
                        if (!s.ah)
            ...
            }, this.Ze = null, this.na = function (e) {
                if (!s.Q) {
                    var t = this.qh.step;
                    ...
                    s.rowlist.filter(function (e) { var t = e.top - l.rh(), i = t + e.height + 2 * l.rh(); return !n || !(i <= a || t >= r); }).forEach(function (n) {
                        s.Kg(n);
                ...
                if (!this.nav.scroll)
                    return !1;
                for (var t = this.nav.scroll.scrollTop - l.rh(), n = t + this.nav.scroll.clientHeight + 2 * l.rh(), i = 0; i < this.rowlist.length; i++) {
                ...
                if (e.rendered)
                    return !1;
                var t = "Progressive" === this.dynamicEventRendering, n = this.nav.scroll.scrollLeft - l.zh(), i = n + this.nav.scroll.clientWidth + 2 * l.zh(), a = e.part.left, r = e.part.left + e.part.width;
                return !t || !(i <= a || n >= r);
            }, this.vh = function (e) {
                if (!e.rendered)
                    return !0;
                var t = this.ne(), n = t.pixels.top, i = t.pixels.bottom, a = t.pixels.left - this.dynamicEventRenderingMargin, r = t.pixels.right + this.dynamicEventRenderingMargin, o = e.part.left, l = e.part.right, d = e.part.top, c = e.part.top + s.eventHeight;
                return r <= o || a >= l || (i <= d || n >= c);
            }, this.Ua = function (e, t) {
                t = t || {};
                var n = t.forced;
                if (e.rendered)
                    return !1;
                var i = "Progressive" === this.dynamicEventRendering, a = e.part.dayIndex, o = s.divEvents, c = s.rowlist, u = c[a], h = u.top, f = this.ne(), v = f.pixels.left - l.zh(), p = f.pixels.right + l.zh(), m = f.pixels.top, g = f.pixels.bottom, y = e.part.left, b = e.part.left + e.part.width, w = e.part.top + h, x = w + s.eventHeight, _ = p <= y || v >= b, C = g <= w || m >= x;
                if (!n && i && (_ || C))
                    return !1;
                ...
                }(), S.areas && (U = U.concat(S.areas)), DayPilot.Areas.attach(A, e, { areas: U }), this.elements.events.push(A), o.appendChild(A), e.rendered = !0, !0;
            }, this.$a = function (e, t) { return s.R.da() ? DayPilot.Util.escapeTextHtml(e, t) : DayPilot.Util.isNullOrUndefined(t) ? DayPilot.Util.isNullOrUndefined(e) ? "" : e : t; }, this.Gh = function (e, t, n) { DayPilot.Util.isNullOrUndefined(n) ? null !== t && void 0 !== t && (s.R.da() ? e.innerText = t : e.innerHTML = t) : e.innerHTML = n; }, this.tf = function () {
                for (var e = 0; e < this.elements.events.length; e++) {
                ...
                var t = s.events.Vf(e.data);
                if (!t)
                    return null;
                var n = s.rowlist[t.part.dayIndex];
                return s.Kg(n), s.Ua(t, { "forced": !0 }), s.Hh(t);
            }, this.Ah = function (e) {
            ...
            d.Mf = [], d.relativeCoords = function (e) { return d.Nh(e); }, d.startResizing = function (e, t) { d.Oh(e, t); }, d.startMoving = function (e, t) { d.Kh(e, t); }, d.Dh = function (t) {
                if (!DayPilot.Global.touch.active && !DayPilot.Global.touch.start) {
                    t.stopPropagation(), d.Ph(), DayPilot.Global.touch.start = !0, DayPilot.Global.touch.active = !1;
                    var n = t.currentTarget;
                    s.coords = d.Nh(t);
                    var i = s.tapAndHoldTimeout;
                    d.Mf.push(setTimeout(function () {
            ...
            }, d.Eh = function () { d.Ph(), DayPilot.Global.touch.start = !1; }, d.Fh = function (e) {
                ...
                if (d.Ph(), DayPilot.Global.touch.start = !1, t.kg)
                    return e.preventDefault(), void d.Sh();
            ...
            }, d.debug = function () { }, d.Tg = function (e) {
                d.Ph();
                if (DayPilot.Global.touch.active) {
                    if (t.Ue) {
                        e.preventDefault();
            ...
            }, this.Ff = function () { var e = s.Re(); return s.days * (1440 / e); }, this.Bf = function (e) {
                if (e = e || t.Qh || s.Df, !e)
                    return null;
                var n = s.rowlist[e.start.y];
                if (!n)
                    return null;
                var i, a, r = e, o = r.end.time > r.start.time, l = n.id, d = o ? r.start.x : r.end.x, c = o ? r.end.x : r.start.x, u = s.snapToGrid;
                u ? (i = s.Oe(d).start, a = s.Oe(c).end) : o ? (i = r.start.time, a = r.end.time) : (i = r.end.time, a = r.start.time);
                var h = new DayPilot.Selection(i, a, l, s);
                ...
                return n;
            }, this.Wh = function (e, t) { var n = this.R.Le(); return t = t || this.cellDuration, t < 1 ? e.toString("ss") : t < 60 ? e.toString("mm") : t < 1440 ? "Clock12Hours" === s.R.Vh() ? e.toString("h tt", n) : e.toString("H", n) : t < 10080 ? e.toString("d") : 10080 === t ? 1 === l.ea() ? e.weekNumberISO() : e.weekNumber() : e.toString("MMMM yyyy", n); }, this.Ke = function (e, t, n) {
                var i, a = s.startDate.addDays(s.days);
                t = t || this.cellGroupBy;
                var r = 60;
                switch (t) {
                    case "Minute":
                ...
                }), s.wg && s.nav.resScrollSpace && (s.nav.resScrollSpace.style.top = s.ce + "px");
            }, this.fh = function (e) {
                if (DayPilot.Global.touch.start || DayPilot.Global.touch.active)
                    return !1;
                if (s.We(e), "Disabled" === s.timeRangeSelectedHandling)
                    return !1;
                ...
                if (s.Yh(s.coords))
                    return !1;
                var i = n.left ? "left" : n.right ? "right" : n.middle ? "middle" : "unknown";
                return s.Zh = i, t.Qh = s.Rh(), t.Qh && (t.$h = s), !1;
            }, this.Rh = function () { var e = {}, t = s.Ne(s.coords.x).x, n = s.getDate(s.coords.x, !0); return e.start = { y: s.Lf(s.coords.y).i, x: t, "time": n }, e.end = { x: t, "time": n }, e.calendar = s, s.Ef(e), e; }, this.hh = function (e) {
                if (s.Ue = {}, s.Df) {
            ...
            }, this.Xh = function () { return !!(t.kg || t.Ue || t.Qh) || !!s.Ue.Lh; }, this.dragInProgress = function () { return s.Xh(); }, this.We = function (e) { var t = DayPilot.mo3(s.je, e); t = t || {}, t.stamp = t.x + "_" + t.y, s.coords && s.coords.stamp === t.stamp || (s.coords = t); }, this.gh = function (e) {
                if (!DayPilot.Global.touch.active) {
                    var n = DayPilot.mc(e);
                    if (s.We(e), s.Ue.Lh) {
            ...
            }, this.ci = function () { var e = t.Qh, n = s.Ne(s.coords.x).x, i = s.getDate(s.coords.x, !0); e.end = { x: n, "time": i }, s.Ef(e); }, this.ai = function () { t.ng || (t.ng = s.ca(t.kg)), s.pg(); }, this.bi = function () {
                if (!t.sg) {
                ...
                s.qg();
            }, this.ih = function (e) { return e.cancelBubble = !0, !1; }, this.Yh = function (e) {
                var t = s.Df;
                if (!t || !t.start || !t.end)
                    return !1;
                var n = this.Of(t.start.y), i = t.start.x < t.end.x, a = (i ? t.start.x : t.end.x) * this.cellWidth, r = (i ? t.end.x : t.start.x) * this.cellWidth + this.cellWidth, o = n.top, l = n.bottom;
                return e.x >= a && e.x <= r && e.y >= o && e.y <= l;
            }, this.Ef = function (e) {
                function n(e) {
            ...
            }, this.di = function (e) { return { "start": { "x": e.start.x, "y": e.start.y, "time": e.start.time }, "end": { "x": e.end.x, "time": e.end.time }, "calendar": e.calendar, "args": e.args }; }, this.getCoords = function () {
                if (!s.coords)
                    return null;
                var e = {};
                e.x = s.coords.x, e.y = s.coords.y;
                var t = s.Lf(e.y, e.grid).element;
                return e.row = s.Eg(t), e.time = s.getDate(e.x, !0), e;
            }, this.Mf = {}, this.Mf.na = null, this.Mf.drawCells = null, this.Mf.drawRows = null, this.Mf.click = null, this.Mf.resClick = [], this.Mf.updateFloats = null, this.jf = function () {
                if (!s.Q) {
                    s.hf();
                    var e = s.nav.scroll;
            ...
            }, this.ei = function () { return function () { s && s.if(); }; }, this.fi = function () { return function () { s && (s.xh() ? setTimeout(function () { s.uh(), setTimeout(function () { s.na(!0); }, 50); }, 50) : s.te()); }; }, this.hf = function () { s.xb.drawArea = null; }, this.show = function () { s.visible = !0, s.ee = !0, s.nav.top.style.display = "", s.u(), s.dh(), s.jf(); }, this.hide = function () { s.visible = !1, s.ee = !1, s.nav.top.style.display = "none"; }, this._f = function (e) {
                if (!s.events.list)
                    return null;
                ...
                if (!this.nav.scroll)
                    return null;
                var e = s.oh, t = {}, n = l.zh(), i = l.rh(), a = s.nh - n, r = a + s.ph + 2 * n, o = 0, d = 0;
                o = s.Ne(a).x, d = s.Ne(r, !0).x;
                var c = this.Ff();
                d = Math.min(d, c - 1), o = DayPilot.Util.atLeast(o, 0);
                var u = e - i, h = e + this.nav.scroll.offsetHeight + 2 * i, f = this.Lf(u).i, v = this.Lf(h).i;
            ...
            }, this.Fe = function () { return s.Ff() * s.cellWidth; }, this.ii = function (e) {
                var t = s.rowlist, n = s.divLines, i = "y_" + e;
            ...
            }, this.af = function () { s.ce = s.ji(s.rowlist); }, this.ji = function (e) {
                for (var t = 0, n = 0; n < e.length; n++) {
                    var i = e[n];
                    i.top = t, t += i.height;
                }
                return t;
            }, this.ff = function () { s.elements.cells = [], s.xb.cells = [], s.divCells.innerHTML = "", s.ki(); }, this.ki = function () { s.divLines.innerHTML = "", s.xb.linesVertical = {}, s.xb.linesHorizontal = {}, s.elements.linesVertical = []; }, this.uf = function (e) {
                var t = [];
                ...
                if (!n)
                    return null;
                var i = s.rowlist[t], a = i.id, r = n.start, o = n.end, l = {};
                if (l.cell = { x: e, y: t, start: r, end: o, resource: a, row: s.Eg(i), properties: s.li(e, t) }, l.control = s, "function" == typeof this.onBeforeCellRender) {
                    var d = e + "_" + t;
                ...
                return l;
            }, this.clearSelection = function () { this.ni(); }, this.oi = function (e, t, n) {
                ...
                if (a <= 1440 && !(s.businessWeekends || t || 0 !== e.start.dayOfWeek() && 6 !== e.start.dayOfWeek()))
                    return !1;
                if (a < 720) {
                    var r = n.getHours();
                ...
                return !0;
            }, this.u = function () { "hidden" === this.nav.top.style.visibility && (this.nav.top.style.visibility = "visible"); }, this.qi = function (e) { this.heightSpec = "Fixed", this.height = e - (this.He() + 2), this.ma(); }, this.setHeight = this.qi, this.le = function (e) { return s.Ig(e)[0]; }, this.wb = function () {
                if (this.id && this.id.tagName)
                    this.nav.top = this.id;
                else {
                    if ("string" != typeof this.id)
                ...
                s.ub = {};
            }, this.zd = {}, this.zd.reactDOM = null, this.zd.react = null, this.zd.Uc = function (e, t) {
                var n = s.zd.reactDOM;
                if ("function" == typeof n.createRoot) {
                    var i = t.Xd;
                    i || (i = n.createRoot(t), t.Xd = i), i.render(e);
            ...
            var i = this;
            i.isRow = !0, i.menuType = "resource", i.name = e.name, i.id = e.id, i.tags = e.tags, i.index = e.index, i.calendar = t, i.data = e.resource, i.vi = e, i.$ = {}, i.$.row = e, i.toJSON = function () { var e = {}; return e.start = this.start, e.name = this.name, e.id = this.id, e.index = this.index, e; }, i.events = {}, i.events.all = function () {
                for (var e = [], t = 0; t < i.vi.events.length; t++)
                    e.push(i.vi.events[t]);
                return e;
        ...
        }, t.Ue = null, t.rg = null, t.Jh = null, t.kg = null, t.og = null, t.Te = !1, t.jh = !1, t._h = null, t.wi = null, t.pc = function () { DayPilot.ue(document, "mouseup", t.be), DayPilot.ue(document, "touchmove", t.kh), DayPilot.ue(document, "touchend", t.lh), t.jh = !1; }, t.kh = function (e) {
            if (t.kg) {
        ...
        }, t.lh = function (e) { t.$g = !1, t.be(e); }, t.be = function (e) {
            if (t.kg) {
