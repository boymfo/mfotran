...
export declare class GanttLinksComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<GanttLinksComponent, "gantt-links-overlay", never, { "flatItems": { "alias": "flatItems"; "required": false; }; }, { "lineClick": "lineClick"; }, never, never, false, never>;
}
