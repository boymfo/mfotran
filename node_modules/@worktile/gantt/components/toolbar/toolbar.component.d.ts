...
export declare class NgxGanttToolbarComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<NgxGanttToolbarComponent, "ngx-gantt-toolbar,gantt-toolbar", never, { "template": { "alias": "template"; "required": false; }; }, {}, never, never, false, never>;
}
