...
@function tethys-icon-char($filename) {
	...
	@if $filename == three-left-sidebar {
		$char: "\E11C";
	}
	@if $filename == three-right-sidebar {
		$char: "\E11D";
	}
	...
	@if $filename == execution-result-completed {
		$char: "\E2FA";
	}
	@if $filename == execution-result-confirmed {
		$char: "\E2FB";
	}
	@if $filename == execution-result-intention {
		$char: "\E2FC";
	}
	@if $filename == execution-result-pending {
		$char: "\E2FD";
	}
	@if $filename == execution-result-quick {
		$char: "\E2FE";
	}
	@if $filename == execution-result-retest {
		$char: "\E2FF";
	}
	@if $filename == high {
		$char: "\E300";
...
.tethys-icon-five-columns {
	@include tethys-icon(five-columns);
}
...
.tethys-icon-four-columns {
	@include tethys-icon(four-columns);
}
.tethys-icon-hashtag {
...
.tethys-icon-one-columns {
	@include tethys-icon(one-columns);
}
...
.tethys-icon-six-columns {
	@include tethys-icon(six-columns);
}
...
.tethys-icon-three-left-sidebar {
	@include tethys-icon(three-left-sidebar);
}
.tethys-icon-three-right-sidebar {
	@include tethys-icon(three-right-sidebar);
}
...
.tethys-icon-arrow-up-circle {
	@include tethys-icon(arrow-up-circle);
}
...
.tethys-icon-angry-fill {
	@include tethys-icon(angry-fill);
}
.tethys-icon-angry {
...
.tethys-icon-check-item {
	@include tethys-icon(check-item);
}
...
.tethys-icon-loading-tt {
	@include tethys-icon(loading-tt);
}
.tethys-icon-locked {
...
.tethys-icon-smile-fill {
	@include tethys-icon(smile-fill);
}
...
.tethys-icon-connect-fill {
	@include tethys-icon(connect-fill);
}
.tethys-icon-deploy {
...
.tethys-icon-sprint-fill {
	@include tethys-icon(sprint-fill);
}
...
.tethys-icon-execution-result-completed {
	@include tethys-icon(execution-result-completed);
}
.tethys-icon-execution-result-confirmed {
	@include tethys-icon(execution-result-confirmed);
}
.tethys-icon-execution-result-intention {
	@include tethys-icon(execution-result-intention);
}
.tethys-icon-execution-result-pending {
	@include tethys-icon(execution-result-pending);
}
.tethys-icon-execution-result-quick {
	@include tethys-icon(execution-result-quick);
}
.tethys-icon-execution-result-retest {
	@include tethys-icon(execution-result-retest);
}
.tethys-icon-high {
	@include tethys-icon(high);
}
...
.tethys-icon-low {
	@include tethys-icon(low);
}
.tethys-icon-medium {
	@include tethys-icon(medium);
}
